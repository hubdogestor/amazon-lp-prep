  ...
  "cases": [
    {
      ...
      "pt": {
        ...
        "r": "Meu novo modelo reduziu o SLA médio de 382 para 62 dias (eficiência de 84%), gerando uma economia de ~ milhões e sendo adotado globalmente pela Huawei. Com isso, entregamos a primeira estação 4G do Brasil e a infraestrutura da Copa de 2014 no prazo. (com baseline, meta e período documentados em relatório executivo).",
      ...
      "en": {
        ...
        "r": "My new model reduced the average SLA from 382 to 62 days (84% efficiency), generating ~ million in savings and being adopted globally by Huawei. With this, we delivered Brazil's first 4G station and the 2014 World Cup infrastructure on time.",
      ...
      },      "fup": [
        {
          ...
          "a_en": "The root cause was the lack of an integrated end-to-end process. Each stage  licensing, construction, activation  was managed as a separate project, creating enormous wait times between them. The solution was to create a single value stream."
        },
        {
          ...
          "a_en": "I didn't impose the model. I presented it in a pilot project with one team. The overwhelming success of that pilot, with visible results in weeks, created organic demand. The other PMs came to me asking to adopt the model because they saw it simplified their lives."
        },
        {
          ...
          "a_en": "The initial version was complex. I simplified it by focusing on just three key metrics: on-time delivery (SLA), first-time delivery quality (no rework), and cost. A simple 0-100 score, easy to understand and communicate, was what ensured adoption."
        },
        {
          ...
          "a_en": "The integration of end-to-end lead time control (from site survey to activation). Before, no one measured the total cycle time. By creating this single view and managing it with the Critical Path Method, we could see and eliminate bottlenecks that were previously invisible."
        },
        {
          ...
          "a_en": "It was creating the 'War Room'. Centralizing 20 suppliers and 30 PMs in a single location, with visual dashboards, eliminated hundreds of emails and misaligned meetings. Communication became instant and decision-making much faster."
        },        {
          ...
          "a_en": "Yes, there were attempts to optimize isolated stages of the process. My approach worked because I treated the rollout as a single system, not as separate parts. The invention wasn't in one piece, but in how all pieces connected."
        },
        {
          ...
          "a_en": "I tested it on a batch of 10 low-criticality stations. This allowed me to validate hypotheses, adjust the model based on real field feedback, and prove its value with concrete data before proposing the rollout for all of Latin America."
        },
        {
          ...
          "a_en": "The biggest resistance came from suppliers, who were used to having looser SLAs. I overcame this by showing them how the new process, despite being faster, was more predictable and, with the VPI, good suppliers could earn more with performance bonuses."
        },
        {
          ...
          "q_en": "If you had to further simplify the 62-day process, where would you focus?",
        ...
        },
        {
          ...
          "a_en": "I was inspired by the Theory of Constraints and the Toyota Production System. The idea of identifying the bottleneck (constraint) and optimizing continuous flow (Lean) was the foundation. I didn't just apply theory, I adapted it to the complex reality of the telecom industry."
        }
      ]
    },    {
