...
const BATCHES = {
  ...
  batch6: ['are_right_a_lot', 'best_employer', 'broad_responsibility', 'frugality', 'hire_and_develop_the_best', 'think_big']
};
...
Batches:
  ...
  batch5: Deal with Ambiguity, Disagree and Commit, Insist on Highest Standards
  batch6: Are Right A Lot, Best Employer, Broad Responsibility, Frugality, Hire and Develop the Best, Think Big
