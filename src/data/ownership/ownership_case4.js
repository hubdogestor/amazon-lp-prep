...
const case_4 = {
  ...
  isGoodCase: true,
  pt: {
    s: `"2.847 pagamentos não reconciliados. US$ 47M travados. BACEN pode multar em 0,5% dos ativos." Minha rotina de auditoria paralela detectou o problema 21 dias antes do cutover Banquo→Bradesco — e todos os diretores queriam empurrar a correção para depois do fechamento para não travar o cronograma. Stakes brutais: 18 clientes priority reclamando de atrasos >48h, multa potencial de R$ 12M do BACEN, e deadline rígido de cutover que não podia ser adiado. Ownership decision: assumir ponta a ponta uma reconciliação que não era minha responsabilidade formal (eu era PMO, não operations owner) ou deixar o problema explodir após o cutover comprometendo clientes.
