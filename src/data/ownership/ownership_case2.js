// Case 2 -// Case 2 - ownership/ Case 2 - ownership/ Case 2 - ownership/ Case 2 - ownership/ Case 2 - ownership/ Case 2 - ownershipownership
const case_2 = {
  ...
  isGoodCase: false,
  pt: {
    s: `O desafio começou quando eu recebi um ofício do BID com alerta vermelho: se em 45 dias a SEFAZ/RS não apresentasse um plano robusto de governança para o PROFISCO II (R$ 180M), o desembolso de US$ 12M seria congelado. Estruturar PMO NÃO ERA MINHA FUNÇÃO—meu contrato dizia apenas suporte metodológico. Mas eu enxergava a CAGE tocando 28 projetos críticos sem governança, três iniciativas duplicadas queimando R$ 4,2M e 18 auditorias em atraso. Cada diretor dizia "isso é da outra secretaria" enquanto 42 mil contribuintes aguardavam melhorias em serviços digitais que nunca chegavam. Eu decidi ir além do meu escopo e assumir responsabilidade de ponta a ponta.`,
    t: "Ignorando meu escopo formal, eu me declarei owner único da governança e assumi responsabilidade pessoal. Eu tracei metas de longo prazo: zerar suspensão de desembolso, eliminar duplicidade, reduzir desvio de prazo de 23% para abaixo de 8% e estruturar mecanismos que sobrevivessem à minha saída. Eu prometi ao Secretário da Fazenda um blueprint em sete dias e rituais operando em 30 sem contratar consultoria externa, pensando em sustentabilidade além do meu contrato.",
    ...
    l: "Eu aprendi que ownership verdadeiro significa assumir responsabilidade além do escopo formal e estruturar mecanismos que sobrevivem à minha saída. No setor público, isso exige provar que disciplina gera valor para o cidadão, não burocracia. Pensar no longo prazo significa criar rituais autoportantes (war rooms, dashboards), capacitar sucessores (8 certificados PMI) e documentar tudo (31 templates). Eu transformei esse caso no meu template: sempre que vejo ineficiência sistêmica, eu tomo ownership e construo mecanismos duradouros—mesmo quando \"não é minha função\"."
  },
  en: {
    s: `The challenge began when I received an IDB red-alert letter: if SEFAZ/RS failed to deliver a robust governance plan for PROFISCO II (R$180M) within 45 days, a US$12M disbursement would be frozen. Structuring a PMO WAS NOT MY ROLE—my contract only covered methodology support. But I saw CAGE running 28 critical projects with no governance, three duplicated initiatives burning R$4.2M, and 18 audits overdue while 42K taxpayers awaited digital improvements that never arrived. Each director said "that's another department's problem." I decided to go beyond my scope and take end-to-end ownership.`,
    t: "Ignoring my formal scope, I declared myself single-threaded owner and took personal responsibility. I set long-term goals: avoid disbursement suspension, eliminate duplication, cut schedule deviation from 23% to below 8%, and build mechanisms that would outlive my contract. I promised the Finance Secretary a blueprint in seven days and live rituals in 30 without hiring external consultants, thinking about sustainability beyond my tenure.",
    ...
    l: "I learned that true ownership means taking responsibility beyond formal scope and building mechanisms that outlive my presence. In the public sector, that requires proving discipline creates citizen value, not bureaucracy. Thinking long-term means creating self-sustaining rituals (war rooms, dashboards), training successors (8 PMI certified), and documenting everything (31 templates). I turned this into my template: whenever I spot systemic inefficiency, I take ownership and build lasting mechanisms—even when \"it's not my job.\""
  },
  fups: [
    {
