...
const case_2 = {
  ...
  en: {
    s: `I received an IDB red-alert letter: if SEFAZ/RS failed to deliver a robust governance plan for PROFISCO II (R$180M) within 45 days, a US$12M disbursement would be frozen. Structuring a PMO WAS NOT MY ROLE—my contract only covered methodology support. But I saw CAGE running 28 critical projects with no governance, three duplicated initiatives burning R$4.2M, and 18 audits overdue while 42K taxpayers awaited digital improvements that never arrived. Each director said "that's another department's problem." I decided to go beyond my scope and take end-to-end ownership.`,
