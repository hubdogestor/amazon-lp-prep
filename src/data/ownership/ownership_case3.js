...
const case_3 = {
  ...
  isGoodCase: false,
  pt: {
    s: `Eu auditava o relatorio mensal de pagamentos internacionais quando vi o alerta vermelho: o custo medio por transacao subiu de R$ 47 para R$ 54 (+15%) em seis meses, adicionando R$ 364k por mes ao P&L (R$ 4,3M anualizados). O SLA explodiu de 2h50 para 4h10 e o NPS premium caiu de 66 para 48; tres dos meus 20 maiores clientes ameaçaram migrar. Estruturar forca-tarefa NÃO ERA MINHA FUNÇÃO—meu mandato formal era apenas transformacao digital. Mas quando confrontei Operacoes, Compliance, TI e Comercial, ouvi "isso nao e nosso problema". O CFO cravou 90 dias para recuperar custo e SLA ou cortaria headcount. Eu decidi ir alem do meu escopo e assumir ownership total da crise.`,
    t: `Mesmo com mandato formal restrito a transformacao digital, eu me declarei owner ponta a ponta e assumi responsabilidade pessoal. Na frente do comite eu prometi cortar ao menos 12% do custo medio, trazer o SLA para menos de 3h e recolocar o NPS acima de 65 dentro de 90 dias. Mais importante: eu tracei o trade-off de longo prazo—pausar features novas de marketing por seis semanas para refactoring da reconciliacao, pensando em prevenir reincidencia. Pedi sete dias para apresentar o plano e garanti entregas tangiveis em 30, sem budget extra.`,
    ...
    l: `Eu aprendi que ownership verdadeiro significa assumir responsabilidade alem do escopo formal, fazer trade-offs impopulares de longo prazo (pausar features para refactoring) e construir mecanismos preventivos que impedem reincidencia. Nao basta apagar incendios—e preciso criar sistemas (RPA, score de risco, dashboard 24/7) que monitoram continuamente e alertam antes da crise. Eu transformei esse caso no meu playbook: sempre que vejo ineficiencia sistemica, eu tomo ownership, negocio trade-offs com impacto financeiro e deixo mecanismos permanentes rodando—mesmo quando "nao e minha funcao". Esse ritual de war room com metrica unica e single-threaded owner virou meu template para crises de pagamentos.`,
  },
  en: {
    s: `I was auditing the international payments monthly report when the red flag popped: average cost per transaction climbed from R$47 to R$54 (+15%) in six months, adding R$364K per month (R$4.3M annualized). SLA ballooned from 2h50 to 4h10 and premium NPS crashed from 66 to 48; three of my top 20 clients threatened to leave. Building a task force WAS NOT MY JOB—my formal remit was only digital transformation. But when I confronted Operations, Compliance, IT, and Commercial I heard "not my problem". The CFO gave me 90 days to recover cost and SLA or he would cut headcount. I decided to go beyond my scope and take total ownership of the crisis.`,
    t: `Although my formal remit was digital transformation, I declared myself end-to-end owner and took personal responsibility. In front of the steering committee I committed to slash at least 12% of unit cost, bring SLA back under three hours, and lift NPS above 65 within 90 days. More importantly: I framed the long-term trade-off—pause new marketing features for six weeks to refactor reconciliation, thinking about preventing recurrence. I asked for seven days to present the plan and promised tangible results in 30 with zero extra budget.`,
    ...
    l: `I learned that true ownership means taking responsibility beyond formal scope, making unpopular long-term trade-offs (pause features for refactoring), and building preventive mechanisms that block recurrence. It's not enough to fight fires—you must create systems (RPA, risk score, 24/7 dashboard) that monitor continuously and alert before the crisis. I turned this into my playbook: whenever I spot systemic inefficiency, I take ownership, negotiate trade-offs with financial impact, and leave permanent mechanisms running—even when "it's not my job." This war-room ritual with single metric and single-threaded owner became my template for payment crises.`,
  },
  fups: [
    {
