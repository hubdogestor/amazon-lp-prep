const insist_on_highest_standards = {
  principle: {
    ...
    description: "Os líderes têm padrões implacavelmente altos. Muitas pessoas podem achar que esses padrões são irrealistamente altos. Os líderes elevam continuamente a barra e conduzem suas equipes a entregar produtos, serviços e processos de alta qualidade.",
