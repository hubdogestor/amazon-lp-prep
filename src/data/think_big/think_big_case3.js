...
const case_3 = {
  ...
  isGoodCase: true,
  pt: {
    s: `Em 2018, o Next operava 6,5 milhões de contas digitais com uptime de 99,98%, porém toda a estratégia seguia confinada ao B2C brasileiro, enquanto concorrentes como Stripe e Adyen avançavam na região. **Analisando o feedback de 340 parceiros, descobri que 68% desejavam APIs simples para oferecer pagamentos a seus próprios clientes.** Vi a oportunidade de transformar um ativo de custo fixo de R$120M/ano em uma plataforma de receita regional, permitindo que milhões de consumidores na América Latina tivessem a mesma experiência de pagamento rápida que oferecíamos no Brasil.`,
  ...
  en: {
    s: `In 2018, Next operated 6.5 million digital accounts with 99.98% uptime, but our strategy was confined to the Brazilian B2C market, while competitors like Stripe and Adyen were expanding in the region. **Analyzing feedback from 340 partners, I discovered that 68% wanted simple APIs to offer payments to their own customers.** I saw the opportunity to turn a R$120M/year fixed-cost asset into a regional revenue platform, allowing millions of consumers in Latin America to have the same fast payment experience we offered in Brazil.`,
