const think_big = {
  ...
  cases: [
    {
      ...
      fups: [
        ...
        },
        {
          ...
          a: "Sim. Eu teria investido mais na criação de uma plataforma de software para gerenciar o processo e os dashboards desde o início, em vez de depender de uma combinação de MS Project e Excel. Embora minha solução frugal tenha funcionado, uma plataforma dedicada teria tornado a replicação global ainda mais rápida e padronizada.",
          ...
          a_en: "Yes. I would have invested more in creating a software platform to manage the process and dashboards from the beginning, instead of relying on a combination of MS Project and Excel. Although my frugal solution worked, a dedicated platform would have made global replication even faster and more standardized."
        },
        {
          ...
          a_en: "I connected the bold vision to their professional pride. I said: 'I're not here just to put out a fire in Brazil. I're here to show the rest of the world how it's done. Let's create the model that everyone at Huawei will want to copy'. This transformed pressure into an opportunity to leave a legacy."
        },
        {
        ...
        },
        {
          ...
          a_en: "It was that to radically accelerate, I first had to stop and redesign everything. The general intuition was 'run faster'. My approach of 'stop, think big and redesign the system' seemed like a delay at first, but it was what enabled exponential speed later."
        }
      ]
    },
    {
  ...
  ,
    
    {
      ...
      title_pt: "Concebi um Programa que Mudou o Jogo (Modelo Integrado CAGE)",
      title_en: "Conceived a Game-changing Program (CAGE Integrated Model)",
      company: "CAGE/SEFAZ-RS",
      period: "2025",
      isTopCase: false,
      pt: {
        s: "Sem modelo unificado, estratégia não virava execução: decisões lentas, priorização difusa e baixa visibilidade.",
        t: "Criar um framework integrado (PMO/VMO) conectando objetivos, portfólio e operação com indicadores úteis.",
        a: "Desenhei arquitetura (mapa visual, níveis, rituais), defini governança e cadência quinzenal, alinhei papéis/fluxos; conectei leading/lagging, integrei BAU e tratei mudança cultural com patrocínio executivo.",
        r: "Ciclo decisório mensal→quinzenal; lead time de aprovação -31%; maior visibilidade executiva e foco no que move a agulha.",
        l: "Pensar grande é tornar visão em mecanismos mensuráveis e hábitos coletivos."
      },
      en: {
        s: "Without a unified model, strategy didn’t translate into execution: slow decisions, fuzzy prioritization, low visibility.",
        t: "Build an integrated framework (PMO/VMO) linking objectives, portfolio and operations with useful indicators.",
        a: "I designed the architecture (visual map, levels, rituals), set governance and a biweekly cadence, aligned roles/flows; connected leading/lagging, integrated BAU, and addressed culture with executive sponsorship.",
        r: "Decision cycle monthly→biweekly; approval lead time -31%; higher executive visibility and focus on needle-movers.",
        l: "Thinking big is turning vision into measurable mechanisms and collective habits."
      },
      fups: [
        { q: "Qual problema real da falta de modelo unificado?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "What problem did the lack of a unified model cause?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Como escolheu indicadores e conectou estratégia à operação?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "How did you choose indicators and connect strategy to operations?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Como obteve buy-in executivo?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "How did you secure executive buy-in?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Que mecanismos geraram redução de ciclo/aprovação?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "Which mechanisms reduced cycle/approval time?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Como mediu visibilidade e qualidade da decisão?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "How did you measure visibility and decision quality?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Como tratou trade-offs velocidade×rigor?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "How did you handle speed×rigor trade-offs?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Como escalou a outras áreas?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "How did you scale to other areas?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Que riscos culturais endereçou?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "What cultural risks did you address?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Se refizesse, como aceleraria adoção?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "If redoing, how would you accelerate adoption?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." },
        { q: "Que resultados estratégicos se viabilizaram depois?", a: "Eu descrevi a decisão, os critérios e a evidência, conectando ao impacto no cliente/operação. Usei dados e mecanismos para mitigar riscos e sustentar escala.", q_en: "Which strategic outcomes became possible later?", a_en: "I described the decision, criteria, and evidence, tied to customer/operations impact. I used data and mechanisms to mitigate risk and sustain scale." }
      ]
    }
