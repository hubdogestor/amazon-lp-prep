  ...
  fups: [
    {
      ...
      a: "Meu erro foi ter apresentado minha proposta como uma escolha 'ou um, ou outro'. Isso polarizou a discussão e forçou uma decisão de soma zero. Eu deveria ter enquadrado a conversa em torno de 'como podemos resolver o churn E o engajamento?', talvez propondo uma versão mais simples do motor para rodar junto com o feed desde o início.",
      q_en: "What was your biggest mistake or failure in this case?",
      a_en: "My mistake was presenting my proposal as an 'either/or' choice. This polarized the discussion and forced a zero-sum decision. I should have framed the conversation around 'how can we solve for both churn AND engagement?', perhaps by proposing a simpler version of the engine to run alongside the feed from the start.",
    },
    {
      ...
      a_en: "Today, I would make the 'lite engine' part of the initial proposal. I would present the feed as the main feature to meet marketing's demand, but with the lite engine integrated as a 'retention pilot'. This would have turned the decision from a 'no' to my idea into a 'yes' for a smarter, hybrid solution.",
    },
    {
      q: "Qual foi o obstáculo mais difícil de superar durante a execução?",
      a: "O obstáculo mais difícil foi manter a moral do time de tecnologia, que via o feed como uma 'feature de vaidade' e estava desmotivado. Para superar isso, eu organizei sessões diárias de 15 minutos para mostrar o impacto dos pequenos incrementos que entregávamos e reforcei a importância estratégica da entrega para o banco, conectando o trabalho deles diretamente ao reconhecimento do CEO.",
      q_en: "What was the most difficult obstacle to overcome during execution?",
      a_en: "The hardest obstacle was maintaining the morale of the tech team, who saw the feed as a 'vanity feature' and were unmotivated. To overcome this, I held daily 15-minute sessions to show the impact of the small increments we were delivering and reinforced the project's strategic importance to the bank, directly connecting their work to the CEO's recognition.",
    },
    {
      q: "Quais foram os principais riscos do feed gamificado e como você os mitigou?",
      a: "O maior risco era o 'engajamento vazio': usuários passariam mais tempo no app sem transacionar mais. Mitiguei isso atrelando as missões de gamificação a ações de alto valor, como configurar pagamentos recorrentes ou usar o cartão de crédito. Isso garantiu que o engajamento estivesse diretamente ligado a KPIs de negócio.",
      q_en: "What were the main risks of the gamified feed, and how did you mitigate them?",
      a_en: "The biggest risk was 'empty engagement': users spending more time in the app without transacting more. I mitigated this by tying the gamification missions to high-value actions, such as setting up recurring payments or using the credit card. This ensured that engagement was directly linked to business KPIs.",
    },
    {
      q: "Pode detalhar a lógica do cálculo do teste A/B que reduziu a intenção de cancelamento em 36%?",
      a: "Nós apresentamos aos usuários de ambos os grupos uma pesquisa de NPS ao final de 14 dias. A última pergunta era: 'Em uma escala de 0 a 10, qual a probabilidade de você cancelar sua conta nos próximos 3 meses?'. O grupo que interagiu com o motor de recomendação teve uma redução de 36% nas respostas entre 7 e 10 (alta intenção) em comparação com o grupo do feed.",
      q_en: "Can you detail the logic of the A/B test calculation that reduced cancellation intent by 36%?",
      a_en: "We presented users in both groups with an NPS survey at the end of 14 days. The final question was, 'On a scale of 0 to 10, how likely are you to cancel your account in the next 3 months?'. The group that interacted with the recommendation engine had a 36% reduction in responses between 7 and 10 (high intent) compared to the feed group.",
    },
    {
      q: "Como você aplicou o aprendizado deste caso em outras frentes?",
      a: "Eu formalizei o conceito de 'MVP paralelo' ou 'piloto furtivo'. Em projetos futuros com stakeholders divididos, passei a alocar 10-15% da capacidade do time para testar uma hipótese alternativa em background. Isso nos permite coletar dados do mundo real sem paralisar a entrega principal, tornando as decisões futuras muito mais fáceis.",
      q_en: "How did you apply the learning from this case in other areas?",
      a_en: "I formalized the concept of a 'parallel MVP' or 'stealth pilot'. In future projects with divided stakeholders, I began allocating 10-15% of the team's capacity to test an alternative hypothesis in the background. This allows us to collect real-world data without halting the main delivery, making future decisions much easier.",
    },
    {
      q: "Como exatamente funcionava o motor de recomendação 'lite'?",
      a: "Era um sistema simples baseado em regras, não em machine learning. Ele analisava o padrão de gastos dos últimos 30 dias e, se identificasse uma despesa recorrente (como aluguel ou assinatura) que ainda não havia ocorrido no mês atual, exibia um card de alerta: 'Lembrete: parece que a conta X ainda não foi paga este mês'. Era simples, mas eficaz.",
      q_en: "How exactly did the 'lite' recommendation engine work?",
      a_en: "It was a simple rule-based system, not machine learning. It analyzed the spending patterns of the last 30 days and, if it identified a recurring expense (like rent or a subscription) that hadn't occurred in the current month, it would display an alert card: 'Reminder: it looks like bill X hasn't been paid this month.' It was simple but effective.",
    },
    {
      q: "Como você garantiu que o desenvolvimento do 'motor lite' não atrasasse a entrega principal?",
      a: "Eu o tratei como um 'projeto de estimação' pessoal. Usei minhas próprias horas para escrever os requisitos e trabalhei diretamente com um desenvolvedor sênior, usando a 'folga' entre as sprints para construir os componentes. Ele nunca esteve no cronograma oficial, então, por definição, não podia atrasá-lo. Foi um risco calculado de gestão.",
      q_en: "How did you ensure that the 'lite engine' development didn't delay the main delivery?",
      a_en: "I treated it as a personal 'pet project.' I used my own hours to write the requirements and worked directly with a senior developer, using the 'slack' between sprints to build the components. It was never on the official schedule, so by definition, it couldn't delay it. It was a calculated management risk.",
    },
    {
      q: "Qual foi a reação do CPO quando viu os resultados do motor 'lite'?",
      a: "Ele foi o primeiro a apoiar o investimento de R$ 8 milhões. Ele admitiu em particular que os dados do piloto 'lite' eram a prova que ele precisava para se convencer e para defender o investimento para o resto da diretoria. Nossa relação profissional se fortaleceu muito depois disso, baseada em um respeito mútuo pela execução.",
      q_en: "What was the CPO's reaction when he saw the results of the 'lite' engine?",
      a_en: "He was the first to support the BRL 8 million investment. He admitted privately that the data from the 'lite' pilot was the proof he needed to be convinced and to defend the investment to the rest of the board. Our professional relationship strengthened significantly after that, based on mutual respect for execution.",
    },
    {
      q: "Como você mediu a queda de 19% na 'intenção de cancelamento'?",
      a: "Utilizamos a mesma pesquisa de NPS antes e depois do lançamento para a base geral de clientes. A queda de 19% representa a redução percentual de usuários que se classificaram entre 7 e 10 na pergunta sobre a probabilidade de cancelar a conta. Foi uma métrica de sentimento, mas que historicamente tinha alta correlação com o churn real.",
      q_en: "How did you measure the 19% drop in 'cancellation intent'?",
      a_en: "We used the same NPS survey before and after the launch for the general customer base. The 19% drop represents the percentage reduction of users who rated themselves between 7 and 10 on the question about the likelihood of canceling their account. It was a sentiment metric, but one that historically had a high correlation with actual churn.",
    },
    {
      q: "Como você formalizou seu comprometimento com a decisão do comitê?",
      a: "Imediatamente após a reunião, enviei um e-mail a todos os membros do comitê com a ata da decisão. No corpo do e-mail, escrevi: 'Agradeço a clareza da decisão. Assumo total responsabilidade pela entrega do feed em 90 dias e meu time já está começando o planejamento hoje'. Isso eliminou qualquer dúvida sobre meu alinhamento.",
      q_en: "How did you formalize your commitment to the committee's decision?",
      a_en: "Immediately after the meeting, I sent an email to all committee members with the minutes of the decision. In the body of the email, I wrote: 'Thank you for the clarity of the decision. I take full responsibility for delivering the feed in 90 days, and my team is already starting the planning today.' This eliminated any doubt about my alignment.",
    },
    {
      q: "Que lição o time de produto aprendeu com essa experiência?",
      a: "O time aprendeu que uma boa ideia não morre só porque não é priorizada. Se você acredita nela, pode encontrar maneiras criativas e de baixo custo para testá-la, como o 'motor lite'. E que a melhor maneira de conseguir recursos para suas ideias é entregando com excelência as prioridades dos outros.",
      q_en: "What lesson did the product team learn from this experience?",
      a_en: "The team learned that a good idea doesn't die just because it's not prioritized. If you believe in it, you can find creative, low-cost ways to test it, like the 'lite engine.' And that the best way to get resources for your ideas is by delivering excellence on others' priorities.",
    },
    {
      q: "O que era mais complexo no código que você assumiu pessoalmente?",
      a: "A lógica de integração com o sistema de cashback era a mais complexa. Envolvia múltiplas chamadas de API assíncronas e precisava garantir que as recompensas da gamificação fossem creditadas em tempo real, sem duplicidade e com latência abaixo de 300ms. Eu revisei o fluxo de transações para garantir que fosse idempotente e escalável.",
      q_en: "What was most complex about the code you personally took over?",
      a_en: "The integration logic with the cashback system was the most complex. It involved multiple asynchronous API calls and needed to ensure that gamification rewards were credited in real-time, without duplication, and with latency below 300ms. I reviewed the transaction flow to ensure it was idempotent and scalable.",
    },
    {
