const case_3 = {
  ...
  isGoodCase: false,
  pt: {
    s: "No refresh do app Next 2023, eu liderava o discovery quando o comitê de produto decidiu priorizar um feed social gamificado para gerar buzz, ignorando dados que mostravam que 61% do churn vinha de clientes sem visibilidade de gastos futuros. Eu defendia um motor de recomendação financeira, mas o CPO pressionou pelo feed para garantir o apoio do marketing. A tensão era clara: seguir a intuição do comitê ou os dados dos clientes.",
  ...
  en: {
    s: "During the 2023 Next app refresh, I was leading discovery when the product committee chose to prioritize a gamified social feed for buzz, ignoring data that showed 61% of churn came from customers lacking future spending visibility. I advocated for a financial recommendation engine, but the CPO pushed for the feed to secure marketing's support. The tension was clear: follow the committee's intuition or the customer data.",
