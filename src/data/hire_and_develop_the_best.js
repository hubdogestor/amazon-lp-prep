  ...
  cases: [
    {
      ...
      "pt": {
        ...
        "a": "Implementei funil de contratação rigoroso com desafios práticos de produto real, entrevistas estruturadas por competência e bar raisers em cada processo. Modelei onboarding intensivo de 90 dias com shadowing, pair working e objetivos claros por milestone. Criei guilda de produto interna, trilhas de mentoria 1:1 e sistema de feedback 360° trimestral.",
        "r": "Tempo de rampup caiu 60% (de 6 para 2.5 meses), qualidade de PRDs e decisões melhorou significativamente (NPS interno de PMs subiu 0.8 pontos), acurácia de roadmap aumentou 15 pontos percentuais e 80% dos PMs contratados foram promovidos internamente em 18 meses. (com baseline, meta e período documentados em relatório executivo).",
        "l": "Aprendi que contratar é só o primeiro passo; elevar sistematicamente a performance bar e desenvolver líderes é o que transforma organizações. Coaching é multiplicador de impacto exponencial. Em retrospectiva, eu poderia ter criado more cross-functional collaboration upfront, e hoje sempre desenho onboarding que conecta com outras áreas desde o início."
      },
      "en": {
      ...
      "fups": [
        {
          "q": "Como você estruturou desafios práticos que realmente avaliassem capacidade de PM?",
        ...
        {
          "q": "O que eram 'bar raisers' no seu processo de contratação?",
          "q_en": "What were 'bar raisers' in your hiring process?",
          "a": "Senior PMs de outras áreas que tinham veto power e focavam em: 'Essa pessoa é melhor que 50% do time atual?' Standard de excelência mantido por peers, não só hiring manager.",
        ...
        {
          "q": "Como funcionava o onboarding de 90 dias na prática?",
          "q_en": "How did the 90-day onboarding work in practice?",
          "a": "Primeiro mês: shadowing + absorção; segundo mês: pair working com mentor; terceiro mês: ownership gradual com safety net. Structured rampup com checkpoints semanais.",
        ...
        {
          "q": "Que métricas você usou para medir sucesso do desenvolvimento?",
          "q_en": "What metrics did you use to measure development success?",
          "a": "Time to first independent decision, quality score de deliverables, 360° feedback evolution e promotion rate within 18 months. Leading + lagging indicators de growth.",
          "a_en": "Time to first independent decision, deliverables quality score, 360° feedback evolution and promotion rate within 18 months. Leading + lagging indicators of growth."
        },
        {
        ...
        {
          "q": "Qual foi o maior desafio ao elevar o padrão de contratação?",
        ...
        {
          "q": "Como você identificava e desenvolvia líderes dentro do time?",
        ...
        {
          "q": "Que papel você assumia pessoalmente no coaching de outros?",
          "q_en": "What role did you personally take in coaching others?",
          "a": "Weekly 1:1s focados em growth, não status. Career development conversations, stretch assignments e honest feedback sobre strengths/gaps. Invest time in people development.",
        ...
        {
          "q": "Como você balanceava desenvolvimento interno vs. contratação externa?",
        ...
        },
        {
          ...
          "a": "Mais cross-functional exposure desde início, AI/ML skills integration e reverse mentoring (juniors teaching seniors). Future-proof development para changing landscape.",
    ...
    },
    {
      ...
      "pt": {
        ...
        "a": "Identifiquei o high performer através de quality of analysis e proatividade em soluções. Criei plano de desenvolvimento estruturado: projetos especiais, mentoria intensiva, exposure a stakeholders seniores e participação em decisões estratégicas. Lobby interno para exceções de progressão e criação de nova posição técnica sênior.",
        "r": "Analista promovido de nível 2 para 5 em 18 meses (vs. 4 anos típicos), liderou 3 projetos estratégicos com sucesso, virou referência técnica interna e desenvolveu 2 outros juniors usando mesmo método. Brain drain prevention através de talent development. (com baseline, meta e período documentados em relatório executivo).",
        "l": "Aprendi que desenvolver talentos excepcionais exige criar oportunidades onde não existiam antes. True leaders quebram barreiras organizacionais para unlock potential. Investment em people é highest ROI decision. Em retrospectiva, eu poderia ter documentado melhor o business case para talent development, e hoje sempre construo formal succession planning que justifica accelerated growth."
      },
      "en": {
      ...
      "fups": [
        {
          "q": "Como você identificou que esse analista tinha potential excepcional?",
          "q_en": "How did you identify that this analyst had exceptional potential?",
          "a": "Behavioral signals: fazia perguntas certas, propunha soluções além do escopo, aprendia fast e tinha natural curiosity. Potential > performance atual em bureaucratic environment.",
        ...
        {
          "q": "Que resistência você enfrentou ao tentar acelerar progressão no setor público?",
          "q_en": "What resistance did you face trying to accelerate progression in public sector?",
          "a": "'Tem que respeitar tempo de casa.' Argumentei com performance data e business need. Criamos nova função técnica specialist que permitiu growth sem quebrar hierarquia tradicional.",
        ...
        {
          "q": "Como você estruturou o plano de desenvolvimento de 18 meses?",
        ...
        {
          "q": "Que tipo de projetos especiais você deu para acelerar desenvolvimento?",
          "q_en": "What type of special projects did you give to accelerate development?",
          "a": "Cross-secretaria initiatives, process improvement projects e direct reporting ao Secretário em temas específicos. High-visibility work que demonstrasse capabilities.",
        ...
        {
          "q": "Como você fez lobby interno para exceções de progressão?",
          "q_en": "How did you lobby internally for progression exceptions?",
          "a": "Business case sólido: cost of replacement, value delivered, risk of losing talent e ROI de investment em development. Numbers speak louder than politics.",
        ...
        {
          "q": "Qual foi a reação dos colegas à progressão acelerada?",
          "q_en": "What was colleagues' reaction to accelerated progression?",
          "a": "Mixed reactions: alguns resentful, outros inspired. Mitigei through transparency sobre criteria e opportunities para outros também. Merit-based advancement é infectious.",
        ...
        {
          "q": "Como você mediu sucesso do desenvolvimento além da promoção?",
          "q_en": "How did you measure development success beyond promotion?",
          "a": "Quality of deliverables, stakeholder feedback, problem-solving capability e ability to develop others. Leadership pipeline creation, não just individual advancement.",
        ...
        {
          "q": "Que papel você assumiu como mentor pessoal?",
          "q_en": "What role did you take as personal mentor?",
          "a": "Weekly coaching sessions, honest feedback sobre gaps, networking introductions e strategic career guidance. Sponsor, não just supervisor. Personal investment em success.",
        ...
        {
          "q": "Se tivesse que desenvolver talent em ambiente burocrático hoje, o que faria diferente?",
