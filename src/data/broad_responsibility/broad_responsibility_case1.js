...
const case_1 = {
  ...
  pt: {
    ...
    a: `Ações pessoais: priorizei mudanças, alinhei stakeholders, tomei decisões de trade-off e removi bloqueios. Comecei com humildade, organizando workshops com nosso DPO. Os workshops cobriram tópicos como 'Bases Legais para Tratamento de Dados de Saúde' e 'Princípios de Minimização de Dados', preparando a equipe para pensar em privacidade desde a concepção. Incorporei um 'Privacy Impact Assessment' (PIA) como um 'quality gate' obrigatório em nosso processo, escolhendo essa abordagem porque a LGPD exige avaliação de impacto para dados sensíveis e queríamos ir além da conformidade básica, criando verdadeira proteção preventiva. Nenhuma nova funcionalidade poderia avançar sem a aprovação formal do DPO. Para o produto de Atenção Primária à Saúde (APS), que envolvia o compartilhamento de dados com uma equipe multidisciplinar, eu liderei pessoalmente o desenho de um novo 'Painel de Consentimento Granular'. O desafio foi técnico e de UX: criamos uma interface simples onde o cliente podia, com checkboxes, controlar exatamente quais dados (ex: histórico, exames) compartilhava com cada profissional (médico, nutricionista). Ao desenhar o produto Pet Saúde, consideramos o ciclo de vida completo do dado. Eu liderei a criação de um processo automatizado, comunicado de forma transparente na política de privacidade, onde os dados do pet eram anonimizados após 12 meses de inatividade do plano, garantindo que não retínhamos informações desnecessariamente.`,
    r: `Lançamos 4 novos produtos digitais em total conformidade com a LGPD, passando por todas as auditorias sem ressalvas. O Painel de Consentimento Granular foi tão bem recebido que foi adotado como o novo padrão para todos os produtos digitais da empresa, incluindo o aplicativo principal que servia a mais de 600 mil usuários, melhorando a governança de dados em escala. Não tivemos nenhum incidente de privacidade ou vazamento de dados relacionado aos novos produtos, protegendo a confiança de 600 mil+ clientes e estabelecendo padrões de governança de dados sensíveis -- princípios que se aplicam diretamente a payment data (informações de cartão, histórico transacional) onde a responsabilidade sobre privacidade é igualmente crítica.`,
  ...
  en: {
    s: `In 2021, the General Data Protection Law (LGPD) came into full force. At Unimed, my success and scale meant I were guardians of health data -- the most sensitive category of personal data -- for hundreds of thousands of people. When leading the launch of 4 new digital products, the responsibility to ensure compliance was not just a legal obligation, but an ethical imperative that would impact millions of lives.`,
    t: `My individual role: I led end-to-end, set scope and critical decisions, and acted as the single-threaded owner. My responsibility was to ensure each product was designed from the beginning with 'Privacy by Design' principles, establishing a new and higher standard of data governance for the innovation area. It was my responsibility to protect not only current customer data, but also establish precedents that would protect future generations of users.`,
    a: `Personal actions: I drove execution—prioritized changes, aligned stakeholders, made trade-offs, and unblocked teams. I started with humility, organizing workshops with my DPO. The workshops covered topics like 'Legal Bases for Health Data Processing' and 'Data Minimization Principles', preparing the team to think about privacy from conception. I incorporated a 'Privacy Impact Assessment' (PIA) as a mandatory 'quality gate' in my process, choosing this approach because LGPD requires impact assessment for sensitive data and I wanted to go beyond basic compliance, creating true preventive protection. No new functionality could advance without formal DPO approval. For the Primary Health Care (APS) product, which involved sharing data with a multidisciplinary team, I personally led the design of a new 'Granular Consent Panel'. The challenge was technical and UX: I created a simple interface where customers could, with checkboxes, control exactly which data (e.g., history, exams) they shared with each professional (doctor, nutritionist). When designing the Pet Health product, I considered the complete data lifecycle. I led the creation of an automated process, transparently communicated in the privacy policy, where pet data was anonymized after 12 months of plan inactivity, ensuring I didn't retain information unnecessarily.`,
    r: `I launched 4 new digital products in full LGPD compliance, passing all audits without exceptions. The Granular Consent Panel was so well received that it was adopted as the new standard for all company digital products, including the main app serving over 600k users, improving data governance at scale. I had no privacy incidents or data breaches related to the new products, protecting the trust of 600k+ customers and establishing sensitive data governance standards -- principles that apply directly to payment data (card information, transaction history) where privacy responsibility is equally critical.`,
  ...
  fups: [
    {
        ...
        "a": "Através de mecanismos. O 'Privacy Impact Assessment' no início de cada projeto era o primeiro. O segundo era um 'checklist de privacidade' que criei e que fazia parte da minha 'Definition of Done' para cada user story que lidava com dados de clientes. Nenhuma história era considerada 'pronta' sem passar por essa verificação.",
        "q_en": "How did you ensure 'Privacy by Design' principles were consistently applied during the four products' development?",
        "a_en": "Through mechanisms. The 'Privacy Impact Assessment' at the beginning of each project was the first. The second was a 'privacy checklist' I created that was part of my 'Definition of Done' for each user story dealing with customer data. No story was considered 'done' without passing this verification."
    },
    {
        ...
        "a_en": "The biggest challenge was technical: integrating the panel with multiple legacy systems from where data was pulled. I overcame this by creating a 'consent management' microservices layer that centralized rules and communicated with old systems, avoiding a complex and risky legacy overhaul."
    },
    {
        ...
        "a_en": "I measured in two ways. On customer experience, through a satisfaction survey that showed an increase in pilot users' perception of 'trust and control'. On governance, the impact was a 100% reduction in data consent-related complaints for products using the new panel."
    },
    {
    ...
    },
    {
        ...
        "a": "Foi a de descartar uma parceria promissora com uma healthtech. A solução deles era inovadora, mas o modelo de compartilhamento de dados deles não atendia aos meu altos padrões de privacidade. Foi uma decisão difícil de curto prazo, mas que protegeu minha responsabilidade de longo prazo com os dados dos clientes.",
        "q_en": "What was the most difficult privacy-related decision you made?",
        "a_en": "It was discarding a promising partnership with a healthtech. Their solution was innovative, but their data sharing model didn't meet my high privacy standards. It was a difficult short-term decision, but protected my long-term responsibility with customer data."
    },
    {
        "q": "Como você garantiu que a equipe entendesse que privacidade não era apenas compliance, mas responsabilidade ética?",
        "a": "Através de storytelling. Nos workshops, eu não falava sobre 'conformidade com a LGPD', mas sobre 'proteger a dona Maria, que confia seus dados de saúde a eu'. Conectei cada decisão técnica ao impacto humano real. Quando as pessoas entenderam que estávamos protegendo pessoas reais, não apenas cumprindo regras, a mentalidade mudou.",
        "q_en": "How did you ensure the team understood that privacy wasn't just compliance, but ethical responsibility?",
        "a_en": "Through storytelling. In workshops, I didn't talk about 'LGPD compliance', but about 'protecting Mrs. Maria, who trusts her health data to us'. I connected each technical decision to real human impact. When people understood I were protecting real people, not just following rules, the mindset changed."
    },
    {
    ...
    },
    {
        ...
        "a_en": "It made privacy and transparency fundamental values, not optional features. In my startup, the first question for any new functionality is: 'How does this impact customer privacy and trust?'. I created a 'Privacy First Checklist' applied to all product decisions, ensuring I never sacrifice customer trust for technical convenience."
    }
]
};
