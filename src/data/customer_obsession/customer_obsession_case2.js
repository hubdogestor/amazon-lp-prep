...
const case_2 = {
  ...
  pt: {
    ...
    r: `Em seis meses entreguei NPS 35 -> 62 (+27), churn 22% -> 9,8% (-12,2 p.p.), abandono 42% -> 15%, tempo de abertura 16 -> 4 minutos, ticket de cross-sell +32%, lead time 11 -> 6 semanas, FCR digital 48% -> 79%. 94% dos clientes permaneceram após 12 meses (benchmark 87%). O programa virou referência cultural no Bradesco; cartões e seguros adotaram o ritual em 2018. Recebi o prêmio interno "Cliente em 1° Lugar" e passei a apoiar outras verticais como evangelista de customer obsession.` ,
    l: `Eu aprendi que customer obsession em banco só acontece quando eu coloco a dor do cliente na frente de quem decide e amarro cada investimento a uma métrica de satisfação. Hoje não aceito backlog sem evidência real e mantenho rituais com clientes como requisito de governança.`
  },
  en: {
    ...
    r: `Six months post-launch I delivered NPS 35 -> 62 (+27), churn 22% -> 9.8% (-12.2 p.p.), abandonment 42% -> 15%, account opening 16 -> 4 minutes, cross-sell ticket +32%, lead time 11 -> 6 weeks, and digital FCR 48% -> 79%. We retained 94% of customers after 12 months (benchmark 87%). The program became the cultural blueprint for Bradesco; cards and insurance adopted it in 2018. I received the "Cliente em 1° Lugar" award and now coach other verticals on customer obsession.` ,
    l: `I learned that customer obsession in banking only happens when I put the customer's pain in front of decision-makers and tie every investment to satisfaction metrics. Today I reject backlog items without real evidence and keep fixed customer rituals as a governance requirement.`
  },
  fups: [
    {
