  ...
  fups: [
    {
      ...
      a_en: "Early on, I trusted the global vendor too much and underestimated the cultural impact of denial. I thought a good technical report would suffice. I learned that data alone isn't enough when there's defensiveness - you need political strategy and a clear business risk narrative."
    },
    {
      ...
      a_en: "I would involve global leadership in the diagnostic stage even earlier, expanding alignment on reputational risks. I would also designate a regional co-leader to share ownership and accelerate cross-timezone decisions."
    },
    {
      q: "Qual foi o obstáculo mais difícil de superar?",
      a: "Convencer o fornecedor e parte do board de que 0,2% de erro era inaceitável. Muitos viam como estatisticamente irrelevant. Para quebrar a barreira, transformei o dado em emoção, simulando a dor real de um cliente travado no sistema.",
      q_en: "What was the most difficult obstacle to overcome?",
      a_en: "Convincing the vendor and part of the board that a 0.2% error rate was unacceptable. Many saw it as statistically irrelevant. To break the barrier, I transformed data into emotion by simulating the real pain of a customer locked out of the system."
    },
    {
      ...
      a_en: "The main risks were: (1) go-live delay, (2) FATCA/KYC failure, and (3) reputational damage. We mitigated them by defining parallel validation windows with engineering, daily checkpoints, and transparent communication to the global board."
    },
    {
      ...
      a_en: "I projected the total volume of accounts with errors and multiplied by the average assets of Private and Premier segments. Manual audit validated 0.05% samples, confirming materiality. I documented everything with SAP trails and auditable SQL reports."
    },
    {
      ...
      a_en: "I used three validation sources: post-go-live access logs, priority ticket monitoring, and interviews with RMs. In the first 30 days, no incidents related to incorrect registrations were reported."
    },
    {
      ...
      a_en: "We adopted 30 unit test scenarios, retroload with hash comparison, and smoke tests supervised by RMs and compliance. The process became a formal prerequisite for subsequent releases."
    },
    {
      ...
      a_en: "The correlation between fields with special characters and authentication failures. That 0.2% concentrated 90% of historical complaints. This insight shifted the focus of mitigation."
    },
    {
      ...
      a_en: "I used RMs as the living voice of the customer. I asked them to report their past experiences directly in executive calls. First-person pain narratives broke through technical skepticism and brought reality to discussions."
    },
    {
      ...
      a_en: "I created 3-day sprints: one technical, one validation, and one correction. I reported daily progress to the COO. This cadence gave leadership confidence without losing depth."
    },
    {
      ...
      a_en: "Yes. The absence of variation and truncated logs in critical fields. Dashboards without noise are suspicious. I learned to use dispersion metrics to assess sample health."
    },
    {
      ...
      a_en: "The 'Skeptical Customer Audit' methodology became standard process in programs in Mexico and the UK. I also adapted the mechanism to Bradesco's digital environment in the Banquo Program, maintaining the same principle: audit through the customer's eyes."
    },
    {
      ...
      a_en: "The byte-to-byte script began running weekly in the background. I created encoding deviation metrics and automatic alerts via Slack. Later, this evolved into a global integrity monitoring tool."
    },
    {
      ...
      a_en: "It shows I don't rely on comfortable numbers - I question, redo, and look through the customer's eyes. For me, 'Dive Deep' means connecting technique, emotion, and real impact, even when it means disagreeing with perfect dashboards."
    }
  ]
};
