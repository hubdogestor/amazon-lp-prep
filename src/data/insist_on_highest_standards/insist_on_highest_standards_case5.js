...
const case_5 = {
  ...
  isGoodCase: true,
  pt: {
    s: "Em marco de 2022, como Head de Produto Digital na Unimed Porto Alegre, uma cooperativa de saude com 695 mil beneficiarios e receita de R$ 3,2 bilhoes, a plataforma de telemedicina que eu havia liderado lancamento registrou um NPS de apenas 28. O cenario era critico: acumulamos 1.370 reclamacoes no trimestre anterior, com medicos abandonando o sistema por instabilidades tecnicas e, o pior, 42% dos beneficiarios idosos enfrentando dificuldades para se conectar. Uma senhora de 82 anos me ligou chorando, dizendo que nao conseguia falar com o medico durante uma crise de asma. A diretoria, preocupada com a imagem publica e possiveis processos judiciais, sugeria ajustes graduais para nao interromper o servico. Mas eu via isso como uma falha fundamental: estavamos deixando de cumprir nossa missao de cuidar das pessoas na hora de maior vulnerabilidade. A responsabilidade era minha, ja que eu havia aprovado o lancamento inicial sem testes suficientes com usuarios reais.",
    t: "Minha tarefa, que eu mesmo propus e negociei diretamente com o CEO, era redefinir o padrao de excelencia para o produto. Estabeleci compromissos claros: pausar o servico por 15 dias para evitar mais danos, admitir publicamente a falha via comunicado oficial e reconstruir a plataforma do zero. A meta era ambiciosa: alcancar um NPS acima de 75 em 90 dias, com o compromisso pessoal de que, se nao atingisse, eu pediria demissao. Nao se tratava apenas de consertar um app, mas de resgatar a confianca dos beneficiarios, medicos e da propria equipe interna, que estava desmotivada com o fracasso inicial. Eu precisava equilibrar opcoes como manter o sistema antigo com patches rapidos ou investir em uma reconstrucao total, optando pela segunda para garantir sustentabilidade a longo prazo.",
    a: "Iniciei a virada com uma abordagem em tres ondas, sempre priorizando decisoes baseadas em dados e feedback real. Na primeira onda, foquei em accountability e escuta ativa: pausei o servico imediatamente e pessoalmente liguei para 87 medicos e 340 pacientes para pedir desculpas e coletar insights diretos. Em uma dessas chamadas, um paciente idoso me disse que o problema nao era so a tecnologia, mas o medo de errar sem apoio humano imediato, o que me levou a priorizar o desenvolvimento de um 'botao de SOS' para conexao rapida com suporte. Analisei hipoteses como se o erro era puramente tecnico ou tambem de usabilidade, usando dados de logs que mostravam 68% das falhas em conexoes instaveis, e decidi migrar para a plataforma Vonage para maior estabilidade, mesmo sabendo do risco de vendor lock-in. Na segunda onda, montei uma war room com representantes de medicos, pacientes e a equipe tecnica, onde avaliei trade-offs: para financiar os R$ 680 mil adicionais na reconstrucao, negociei o adiamento de um projeto de marketing, o que gerou um conflito com o CMO, mas defendi a decisao com dados projetando uma perda de R$ 2 milhoes em churn se nao agissemos. Priorizei features como interface simplificada, reduzindo de 14 para 4 telas no fluxo de consulta. Na terceira onda, liderei a reescrita do codigo, testando pessoalmente com 120 beneficiarios em suas casas para validar em condicoes reais. Identifiquei um analista junior, o Bruno, que estava desmotivado, e em vez de afasta-lo, deleguei a ele a consolidacao do feedback dos testes, ajudando-o a crescer e apresentando seu relatorio diretamente para a diretoria.",
    r: "O relancamento em junho de 2022 foi transformador: o NPS saltou de 28 para 84 em 90 dias, com o tempo medio de setup caindo de 12 minutos para 2 minutos e 20 segundos, e o volume de consultas triplicando de 1.200 para 3.600 por mes. O investimento de R$ 680 mil foi recuperado em apenas 4 meses atraves do aumento na retencao de beneficiarios, evitando um churn projetado de R$ 1,2 milhao. Mas os ganhos foram alem dos numeros: criei o 'Excellence Gate', um mecanismo obrigatorio que exige NPS minimo de 70 em testes piloto para qualquer novo lancamento, garantindo sustentabilidade. Seis meses depois, ja sem meu envolvimento direto, esse gate barrou um app de agendamento com NPS 55, forçando a equipe a refinar e lancar com 78. O Bruno, que mentorei, liderou essa reavaliacao, mostrando o impacto humano no desenvolvimento de talentos. Trade-offs como o vendor lock-in valeram a pena, pois elevamos o padrao geral, reduzindo reclamacoes em 92% e melhorando a satisfacao dos medicos de 45% para 89%.",
    l: "Essa experiencia me ensinou que excelencia nao e um destino, mas um compromisso diario que exige coragem para admitir falhas e recomeçar. Se eu tivesse conduzido 40 entrevistas profundas com pacientes idosos antes do MVP inicial, teria evitado o desperdicio de R$ 1,8 milhao em desenvolvimento equivocado e o sofrimento desnecessario dos usuarios. Hoje, eu faria diferente priorizando ainda mais a validacao em campo desde o dia um, integrando usuarios reais no design thinking inicial. Apliquei esse aprendizado em projetos subsequentes na SEFAZ, onde implantei gates semelhantes para aprovacoes de sistemas fiscais, evitando lancamentos prematuros e garantindo adesao regulatoria. Tambem percebi que um padrao alto so se mantem se voce investe em pessoas: desenvolver o Bruno nao so salvou o projeto, mas criou um multiplicador de excelencia na equipe."
  },
  en: {
  ...
  fups: [
    {
      ...
      a: "Meu maior erro foi aprovar o lancamento inicial sem testes suficientes com usuarios reais, especialmente idosos. Eu confiei demais em metricas internas de estabilidade e ignorei a usabilidade em condicoes reais, como conexoes ruins. Isso resultou em R$ 1,8 milhao desperdicados e sofrimento para os beneficiarios, algo que poderia ter sido evitado com 40 entrevistas profundas antes do MVP.",
    ...
    },
    {
      ...
      a: "Hoje, eu integraria usuarios reais no design thinking desde o dia um, com pelo menos 50% dos testes em campo. Tambem estabeleceria um 'Excellence Gate' antes mesmo do MVP, exigindo NPS minimo em prototipos. Isso aceleraria a identificacao de falhas e evitaria lancamentos prematuros, priorizando sustentabilidade desde o inicio.",
    ...
    },
    {
      ...
      a: "O obstaculo mais dificil foi o conflito interno com o CMO pelo adiamento do projeto de marketing para financiar a reconstrucao. Ele via isso como perda de visibilidade imediata, mas eu defendi com dados de churn projetado. Superei negociando um plano conjunto onde parte do orcamento de marketing foi realocado para promover o novo lancamento, alinhando interesses.",
    ...
    },
    {
      ...
      a: "Os principais riscos eram perda de receita durante a pausa (R$ 200 mil estimados) e vendor lock-in com Vonage. Mitiguei o primeiro comunicando transparentemente aos beneficiarios e oferecendo alternativas como consultas presenciais gratuitas. Para o segundo, negociei acesso total a dados e criei uma camada de abstracao no codigo, reduzindo o esforco de migracao futura em 60%.",
    ...
    },
    {
      ...
      a: "Usei dados de logs (68% falhas em conexoes), NPS (28 inicial), reclamacoes (1.370) e churn projetado (R$ 1,2 milhao). A racional para churn foi: taxa historica de 15% multiplicada pelo numero de usuarios afetados (42% idosos), vezes LTV medio de R$ 5 mil por beneficiario. Para ROI, dividi investimento (R$ 680 mil) pela receita adicional de consultas triplicadas, projetando payback em 4 meses.",
    ...
    },
    {
      ...
      a: "Apliquei o conceito de 'Excellence Gate' na SEFAZ, criando checkpoints para aprovacoes de sistemas fiscais que exigem aderencia minima a metricas de usabilidade antes de lancamento. Isso evitou dois lancamentos prematuros em projetos de arrecadacao, reduzindo riscos regulatorios. Tambem uso a pratica de escuta ativa em mentorias, incentivando equipes a validar ideias com usuarios reais desde o inicio.",
    ...
    },
    {
      ...
      a: "Minha capacidade de empatia combinada com analise de dados. Ouvir pacientes chorando me motivou, mas foram os dados de logs e NPS que guiaram as decisoes. Essa combinacao me permitiu defender trade-offs dificeis, como o adiamento de marketing, com argumentos solidos que convenceram a diretoria.",
    ...
    {
      q: "Como voce lidou com resistencia cultural na equipe?",
    ...
    {
      q: "Qual foi a sustentabilidade e escalabilidade do 'Excellence Gate'?",
      a: "O 'Excellence Gate' e escalavel, aplicado em todos lancamentos digitais da Unimed, e sustentavel por ser um processo documentado com metricas claras, independente de lideres individuais. Seis meses apos minha saida, ele ja barrou e refinou dois projetos, provando sua durabilidade.",
    ...
    },
    {
      ...
      a: "Para ROI, somei custos (R$ 680 mil) e dividi pela receita adicional de consultas triplicadas (R$ 420 mil/mes), resultando em payback de 4 meses. NPS subiu 200% (28 para 84), baseado em surveys padronizados. Reclamacoes caíram 92%, de 1.370 para 110, rastreando via sistema de tickets.",
    ...
    },
    {
      ...
      a: "Apresentei dados concretos de churn e NPS baixo como risco reputacional, e propus um plano com milestones claros. Negociei trade-offs, como realocar orcamento de marketing, mostrando beneficios de longo prazo. Essa transparencia construiu confianca, com o CEO aprovando apos ver o compromisso pessoal de demissao.",
    ...
    {
      q: "Como voce mitigou o risco de 'vendor lock-in' da Vonage?",
      a: "Embora tenhamos aceitado o risco para ganhar estabilidade, negociei um contrato que nos dava acesso total aos logs e dados de performance, e criei uma camada de abstracao no codigo. Isso nos permitiria, se necessario no futuro, migrar para outro fornecedor com um esforco 60% menor do que uma integracao direta.",
    ...
    },
    {
      ...
      a: "O Bruno, analista junior, estava desmotivado e via a reconstrucao como 'retrabalho'. Em vez de delegar, convidei-o para me acompanhar em tres visitas a pacientes. Ver o impacto real mudou sua perspectiva. Ele se tornou obcecado pela simplicidade e contribuiu mais para a reducao das 14 telas.",
    ...
    },
    {
      ...
      a: "Sim. Seis meses depois, o 'Excellence Gate' barrou o lancamento de um novo app de agendamento que, embora funcional, teve NPS de 55 no piloto. A equipe, liderada pelo Bruno, usou o feedback para mais um ciclo de refinamento, e o app foi lancado com NPS de 78. O mecanismo provou que a cultura de excelencia foi internalizada.",
    ...
    {
      q: "Como voce sistematizou o ciclo de feedback para que a escuta ativa nao dependesse so de voce?",
      a: "Criei o programa 'Voz do Cliente', um ritual quinzenal onde um membro da equipe de produto conversa com tres usuarios e apresenta os aprendizados para o time. Integramos uma ferramenta de feedback continuo no app. A escuta ativa se tornou um processo, nao uma iniciativa heroica.",
    ...
    },
    {
      ...
      a: "A satisfacao dos medicos subiu de 45% para 89%, medido por surveys mensais. Com a estabilidade da Vonage e interface simplificada, eles relataram menos interrupcoes e mais foco no atendimento. Isso reduziu o abandono de 22% para 3%, fortalecendo nossa rede de profissionais.",
    ...
    },
    {
      ...
      a: "Migramos para Vonage para conexoes estaveis e implementamos reconhecimento facial para login, reduzindo passos manuais. Testes mostraram que 70% do tempo anterior era gasto em autententicacao; com isso, caimos de 12 minutos para 2m20s, validado em 120 testes domiciliares.",
    ...
    {
      q: "Como voce mediu o impacto no churn de beneficiarios?",
      a: "Rastreie o churn mensal de usuarios da telemedicina, que caiu de 15% para 6% apos o relancamento. Multipliquei pela base afetada (42% idosos) e LTV (R$ 5 mil), estimando economia de R$ 1,2 milhao. Dados vieram do CRM, comparando periodos pre e pos.",
