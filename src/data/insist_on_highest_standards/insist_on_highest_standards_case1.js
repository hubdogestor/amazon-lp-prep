...
const case_1 = {
  ...
  title: "Criei o padrao 'Zero Data Loss' e os mecanismos que garantiram uma migracao de R$3 Bi sem erros",
  ...
  isGoodCase: true,
  pt: {
    s: "Em maio de 2015, como PMO Manager no HSBC Brasil, uma operacao bancaria com mais de 5 milhoes de clientes e ativos de R$ 170 bilhoes, liderei a migracao da operacao para o Bradesco apos a aquisicao anunciada. O cenario era de alta pressao: a expectativa da industria e dos consultores externos era uma taxa de erro aceitavel de ate 0,05%, o que significaria perda de dados para ate 1.350 clientes em um portfolio de R$ 3 bilhoes que eu gerenciava diretamente. Para mim, cada um desses dados representava a vida financeira de uma pessoa real, como um cliente que dependia do historico de transacoes para disputas judiciais. Aceitar esse padrao minaria a confianca no momento mais critico da transicao, especialmente com reguladores como o Banco Central observando de perto.",
    t: "Minha tarefa, que assumi alem do meu escopo inicial e negociei diretamente com o diretor executivo, era redefinir o padrao de sucesso para a migracao. Estabeleci um criterio muito mais alto: 'zero data loss', desafiando o benchmark da industria. Meu objetivo nao era apenas gerenciar a transicao, mas criar mecanismos replicaveis que tornassem esse padrao realidade, equilibrando opcoes como aceitar erros minimos para cumprir prazos ou investir em prevencao total, mesmo que isso atrasasse fases e aumentasse custos iniciais, priorizando a integridade a longo prazo para clientes e o banco.",
    a: "Para alcancar isso, criei e implementei tres mecanismos centrais, sempre priorizando decisoes baseadas em dados e feedback da equipe. Primeiro, desenvolvi um mecanismo de auditoria de lideranca: eu pessoalmente auditava 500 contas por amostragem em cada ciclo de testes, validando 15 campos criticos como saldos, historicos de transacoes e dados pessoais. Em uma auditoria, identifiquei uma falha na conversao de caracteres especiais que afetaria 12.000 clientes com acentos em nomes, hipotese que avaliei contra opcoes como patches rapidos, decidindo por uma reescrita completa do modulo para evitar recorrencias. Envolvi equipes globais na India, Polonia e China, priorizando comunicacao diaria para alinhamento. Segundo, implantei um playbook de resposta a defeitos baseado na regra 'stop the line', onde qualquer membro da equipe podia pausar a migracao ao detectar anomalias. Eu mesmo acionei isso as 22h de uma terca-feira ao notar uma discrepancia em testes noturnos, arcando com um atraso de dois dias que evitou um erro que custaria 10 vezes mais em remediacao, decidindo contra pressoes para prosseguir. Terceiro, criei um sistema de engajamento global: alem de metricas, compartilhei historias reais de clientes para humanizar o impacto, superando resistencia cultural em times remotos e transformando o 'impossivel' em meta compartilhada, com workshops semanais para coletar e incorporar feedback.",
    r: "O resultado foi um marco na industria: migramos 100% das contas e mais de R$ 3 bilhoes em ativos com zero perda de dados, comparado a expectativa de ate 0,05% de erros que teriam afetado 1.350 clientes. Isso evitou um risco estimado de R$ 15 milhoes em custos de remediacao, multas regulatorias e compensacoes, com zero reclamacoes de clientes sobre dados perdidos. Os dashboards de integridade que desenvolvi reduziram o tempo de deteccao de anomalias de 72 para menos de 12 horas, e o 'Zero Data Loss Playbook' foi adotado como padrao global para migracoes no banco. Trade-offs como atrasos iniciais valeram a pena, pois elevaram a confianca dos clientes, com NPS pos-migracao 15% acima do projetado, e criaram sustentabilidade, com o padrao sendo usado em migracoes subsequentes sem minha intervencao direta.",
    l: "Essa experiencia moldou minha abordagem a qualidade: aprendi que padroes altos nao se fiscalizam, mas se constroem no DNA da equipe com mecanismos robustos. Meu erro foi subestimar inicialmente a resistencia cultural em times globais, o que prolongou o alinhamento; hoje, faria diferente iniciando com workshops de engajamento para mapear duvidas cedo. Apliquei isso em projetos na Huawei, onde implantei playbooks semelhantes para rollouts de rede, reduzindo erros em 40%. Em Payments Ops, essa obsessao por integridade e diretamente aplicavel, onde cada transacao precisa ser rastreavel sem falhas, priorizando prevencao sobre remediacao para construir confianca duradoura."
  },
  en: {
  ...
  fups: [
    {
      ...
      a: "Meu maior erro foi subestimar a resistencia cultural inicial nas equipes globais, o que atrasou o alinhamento em duas semanas. Confiei demais em metricas sem humanizar o impacto cedo, o que gerou duvidas nao expressas. Poderia ter evitado com workshops de engajamento desde o comeco.",
    ...
    },
    {
      ...
      a: "Hoje, integraria historias de clientes reais nos workshops iniciais para humanizar o padrao desde o dia um, acelerando o buy-in cultural. Tambem adicionaria metricas de engajamento humano ao playbook, como surveys semanais, para detectar resistencias cedo e ajustar.",
    ...
    },
    {
      ...
      a: "O obstaculo mais dificil foi a pressao para aceitar erros 'aceitaveis' da industria, especialmente de consultores externos. Superei defendendo com dados o custo de remediacao 10x maior, mudando o foco de 'prazo' para 'integridade de longo prazo' em reunioes com a diretoria.",
    ...
    },
    {
      ...
      a: "Principais riscos eram atrasos no cronograma e resistencia cultural. Mitiguei atrasos com o 'stop the line' calibrado para pausas curtas e focadas, e resistencia com engajamento global via historias reais, reduzindo objeccoes em 70% apos os primeiros workshops.",
    ...
    },
    {
      ...
      a: "Usei dados de auditorias (500 contas/ciclo, 15 campos) e benchmarks (0,05% erro industria). Para risco evitado, multipliquei clientes afetados potenciais (1.350) pelo custo medio de remediacao (R$ 11 mil), projetando R$ 15 milhoes, comparando pre-pos migracao.",
    ...
    },
    {
      ...
      a: "Apliquei o 'Zero Data Loss' na Huawei para migracoes de dados em rollouts de rede, reduzindo erros em 40%. Em Payments Ops, uso playbooks semelhantes para transacoes, garantindo rastreabilidade total e elevando padroes de integridade em operacoes criticas.",
    ...
    {
      q: "Como voce equilibrou o trade-off entre velocidade e qualidade?",
    ...
    {
      q: "Qual o impacto humano dessa migracao perfeita?",
    ...
    },
    {
      ...
      a: "Superei com engajamento via historias reais de clientes, transformando metricas abstratas em impacto humano. Workshops semanais coletaram feedback, ajustando o playbook para nuances locais, reduzindo resistencia de 80% para 10% em duas semanas.",
    ...
    },
    {
      ...
      a: "O playbook e sustentavel por ser documentado com mecanismos como auditorias e 'stop the line', independente de lideres. Foi replicado em migracoes globais apos minha saida, reduzindo erros em 35% em projetos semelhantes.",
    ...
    },
    {
      ...
      a: "Multipliquei clientes afetados potenciais (1.350) pelo custo medio de remediacao (R$ 11 mil, incluindo compensacoes e multas). Comparado a benchmark de 0,05%, projeccao conservadora baseada em casos passados no setor bancario.",
    ...
    },
    {
      ...
      a: "Com relatorios semanais destacando progressos e riscos mitigados, vinculando ao impacto financeiro. Em uma reuniao, defendi o 'zero loss' com dados de custo de remediacao, ganhando apoio ao mostrar retorno 10x no investimento em qualidade.",
    ...
    },
    {
      ...
      a: "Minha persistencia em elevar padroes, combinada com empatia para humanizar dados. Isso me permitiu desafiar benchmarks e engajar equipes globais, transformando resistencia em compromisso coletivo pela integridade.",
    ...
    },
    {
      ...
      a: "Introduziu 'stop the line' como politica global, empoderando equipes a priorizar qualidade. Reduziu incidentes pos-migracao em 50%, com dashboards fornecendo visibilidade real-time para decisoes informadas.",
    ...
    },
    {
      ...
      a: "O dashboard cruzava saldos finais do HSBC com aberturas no Bradesco. Detectou discrepancia de R$ 0,01 em 300 contas, revelando erro de arredondamento que impactaria milhares de contas de investimento se nao corrigido.",
    ...
    },
    {
      ...
      a: "Aprenderam a quantificar 'custo da nao-qualidade'. Viram padroes altos como investimento que mitiga riscos maiores, mudando discussao de 'custo para fazer certo' para 'custo se errarmos'.",
    ...
    {
      q: "Houve algum momento em que voce duvidou que o padrao 'zero data loss' seria alcancavel?",
      a: "Sim, ao descobrir falha de caracteres. Pareceu complexo demais para o prazo, mas o framework com 'stop the line' e war room me deu confianca no sistema para lidar com desafios.",
    ...
    },
    {
      ...
      a: "Transformador: qualidade virou responsabilidade coletiva. Um junior na India apontou falha, impensavel antes. Aumentou engajamento e accountability em todos niveis.",
