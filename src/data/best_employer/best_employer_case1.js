const case_1 = {
  ...
  "isGoodCase": true,
  "pt": {
    "s": "Quando eu assumi o portfólio de produto no Bradesco Next como Head de Produto, eu liderei a migração de 65 squads para um modelo remoto, mas o senso de pertencimento da minha equipe de 120 PMs que eu gerenciava caiu 12 pontos e eu descobri através de pesquisa que conduzi que 47% não viam um plano de carreira, resultando em 18% de rotatividade que me preocupava diretamente. A situação que eu enfrentava era um campo minado de stakeholders: marketing exigia treinamento em growth, compliance impunha trilhas regulatórias, e TI demandava conteúdo técnico, paralisando qualquer avanço que eu tentasse fazer.",
