...
const typicalQuestions = {
  ...
  "ownership": {
    pt: [
      ...
      "Descreva uma decisão importante ou urgente que você tomou sem consultar seu gestor. Qual foi o racional e como você comunicou a ele depois?",
    ...
    en: [
      ...
      "Describe an important or urgent decision you made without consulting your manager. What was the rationale, and how did you communicate it to them afterward?",
  ...
  "bias_for_action": {
    pt: [
      ...
      "Conte sobre um projeto com prazo muito curto, um deadline agressivo ou onde a velocidade era crítica. Como você agiu para garantir a entrega?",
    ...
    en: [
      ...
      "Tell me about a project with a very short timeline, an aggressive deadline, or where speed was critical. How did you act to ensure delivery?",
  ...
  "earn_trust": {
    pt: [
      "Qual foi o feedback mais difícil, negativo ou surpreendente que você recebeu? Como você lidou e o que mudou a partir dele?",
      ...
      "Conte sobre um desacordo ou conflito com um colega ou gestor. Como você resolveu a situação para focar no resultado para o cliente?",
    ...
    en: [
      ...
      "Tell me about a disagreement or conflict with a colleague or manager. How did you resolve the situation to focus on the customer outcome?",
  ...
  "dive_deep": {
    pt: [
      "Conte sobre uma vez que você resistiu a uma solução óbvia para mergulhar nos dados e descobrir a verdadeira causa raiz de um problema. O que você descobriu que os outros não viram?",
  ...
  "deliver_results": {
    pt: [
      ...
      "Conte sobre uma vez que você previu que não ia entregar no prazo. O que você fez a respeito? Como comunicou o atraso?",
    ...
    en: [
      ...
      "Tell me about a time you anticipated you would miss a deadline. What did you do about it? How did you communicate the delay?",
