  ...
  "fups": [
    {
      ...
      "a": "Subestimei a resistência dos auditores médicos no início. Falei apenas em dados e ignorava o impacto emocional. Quando passei a abrir as reuniões com histórias de pacientes, a adesão aconteceu espontaneamente. Quantifiquei que as autorizações caíram de 5,1 dias para 9 horas, redução de 96%.",
      "q_en": "What was your biggest mistake or failure in this case?",
      "a_en": "I underestimated medical auditors’ resistance early on. I focused on data, ignoring the emotional layer. Once I started meetings with real patient stories, support came naturally. I quantified authorization dropping from 5.1 days to 9 hours—a 96% cut."
    },
    {
      "q": "O que você faria diferente hoje?",
      "a": "Começaria com piloto de menor complexidade clínica, gerando confiança mais rápido, e traria o conselho médico para o design do modelo desde o primeiro dia. Mostrei que atingimos 82% de automação sem aumentar erro clínico e o NPS chegou a 67.",
      "q_en": "What would you do differently today?",
      "a_en": "I would start with a smaller, low-complexity pilot to build trust faster and engage the medical board from day one in co-design, not only validation. I showed automation reaching 82% with zero clinical error increase and NPS hitting 67."
    },
    {
      "q": "Qual foi o obstáculo mais difícil de superar que você enfrentou?",
      "a": "A resistência cultural dos médicos, que viam a IA como risco à autonomia clínica. Superei criando o Painel de Confiança, que explicava cada decisão em linguagem médica e mostrava que a IA ampliava sua capacidade. Detalhei que o tempo de angústia das famílias reduziu 89% com acompanhamento humano.",
      "q_en": "What was the most difficult obstacle you faced and overcame?",
      "a_en": "Cultural resistance from doctors who saw AI as a threat to autonomy. I overcame it through the Confidence Panel, which translated each decision into medical reasoning showing AI as augmentation, not replacement. I detailed family distress time falling 89% because of real human follow-up."
    },
    {
      "q": "Quais foram os principais riscos e como você os mitigou?",
      "a": "Viés algorítmico, erro médico e rejeição regulatória. Rodei fairness metrics, removi 11 variáveis socioeconômicas, executei piloto controlado até falso positivo <1,5% e entreguei logs explicáveis à ANS mensalmente. Reforcei que 2.847 pacientes oncológicos receberam tratamento na janela correta.",
      "q_en": "What were the main risks and how did you mitigate them?",
      "a_en": "Algorithmic bias, medical error, and regulatory rejection. I ran fairness metrics, removed 11 socioeconomic variables, conducted a controlled pilot until false positives dropped below 1.5%, and sent monthly explainability logs to the regulator. I reinforced that 2,847 oncology patients were treated within the clinical window."
    },
    {
      "q": "Que dados você usou e qual foi a racional de cálculo?",
      "a": "Usei histórico de 127 mil autorizações em 18 meses, cruzando sinistralidade e tempo de resposta. O 'tempo de angústia' = (horas entre solicitação e decisão) × (criticidade clínica de 1 a 5). Casos com score >50 eram priorizados. Expliquei que geramos R$ 2,4 milhões em economia operacional e contratos foram renovados antecipadamente.",
      "q_en": "What data did you use and what was the calculation rationale?",
      "a_en": "Used 127 k historical authorizations over 18 months, cross-referenced with claim cost and processing time. 'Distress time' = (hours between request and decision) × (clinical criticality 1-5). Scores > 50 were prioritized. I explained we saved BRL 2.4M in operating costs while partners renewed contracts early."
    },
    {
      "q": "Como você usou o aprendizado desse caso em outras frentes ou trabalhos?",
      "a": "Reapliquei o Painel de Confiança em reembolso odontológico (SLA de 6 dias → 26 h) e adaptei o indicador de angústia em underwriting de sellers em fintech, reduzindo tempo de aprovação para < 2 h. Também ajudei outras três cooperativas a replicar o modelo. Quantifiquei que as autorizações caíram de 5,1 dias para 9 horas, redução de 96%.",
      "q_en": "How did you use this learning in other areas or work?",
      "a_en": "I reused the Confidence Panel in dental reimbursement (SLA 6 days → 26 h) and adapted the distress metric to seller underwriting in fintech, cutting approval to under 2 h. I also trained three medical co-ops to replicate the framework. I quantified authorization dropping from 5.1 days to 9 hours—a 96% cut."
    },
    {
      "q": "Como você selecionou os 58 atributos do modelo?",
      "a": "Baseei-me em 12 entrevistas com auditores e em ganho de informação > 0,02; descartei atributos redundantes e mantive somente os clinicamente relevantes. Mostrei que atingimos 82% de automação sem aumentar erro clínico e o NPS chegou a 67.",
      "q_en": "How did you select the 58 model attributes?",
      "a_en": "I based selection on 12 auditor interviews and information gain > 0.02, discarding redundant features and keeping only clinically relevant ones. I showed automation reaching 82% with zero clinical error increase and NPS hitting 67."
    },
    {
      "q": "Que decisão técnica foi mais sensível?",
      "a": "Excluir atributos de renda e região. Reduziu levemente acurácia, mas trouxe justiça e confiança do corpo clínico. Detalhei que o tempo de angústia das famílias reduziu 89% com acompanhamento humano.",
      "q_en": "What was the most sensitive technical decision?",
      "a_en": "Eliminating income- and region-based features. It slightly reduced accuracy but increased fairness and trust in the system. I detailed family distress time falling 89% because of real human follow-up."
    },
    {
      "q": "Como garantiu explicabilidade regulatória para a ANS?",
      "a": "Integrei o painel com logs de pesos e justificativas do modelo, e gerei relatórios assinados digitalmente. A ANS elogiou o formato de auditoria contínua. Reforcei que 2.847 pacientes oncológicos receberam tratamento na janela correta.",
      "q_en": "How did you guarantee explainability to the regulator?",
      "a_en": "I embedded weight logs and reasoning into the panel and produced digitally signed monthly reports. The regulator praised the continuous-audit format. I reinforced that 2,847 oncology patients were treated within the clinical window."
    },
    {
      "q": "Como comprovou impacto financeiro além de FTE?",
      "a": "Comprovei queda de 5,6 % em reembolsos emergenciais e alta de 2,1 % em planos premium por renovações antecipadas, ligando tempo de resposta à receita. Expliquei que geramos R$ 2,4 milhões em economia operacional e contratos foram renovados antecipadamente.",
      "q_en": "How did you prove financial impact beyond FTE savings?",
      "a_en": "I demonstrated a 5.6 % drop in emergency reimbursements and 2.1 % growth in premium renewals - linking faster response time to revenue. I explained we saved BRL 2.4M in operating costs while partners renewed contracts early."
    },
    {
      "q": "Qual dado melhor representa o sucesso humano do projeto?",
      "a": "A redução do 'tempo de angústia' médio de 127 h para 13 h por paciente. Esse número virou métrica-símbolo de empatia operacional. Quantifiquei que as autorizações caíram de 5,1 dias para 9 horas, redução de 96%.",
      "q_en": "Which data best reflects the human success of the project?",
      "a_en": "Average ‘distress time’ dropped from 127 h to 13 h per case - a symbolic indicator of operational empathy. I quantified authorization dropping from 5.1 days to 9 hours—a 96% cut."
    },
    {
      "q": "Que habilidade pessoal foi decisiva?",
      "a": "Transformar dados técnicos em linguagem emocional. Foi assim que o projeto deixou de ser IA e virou cuidado. Mostrei que atingimos 82% de automação sem aumentar erro clínico e o NPS chegou a 67.",
      "q_en": "Which personal skill proved decisive?",
      "a_en": "Turning technical data into emotional language - that’s how the project stopped being about AI and became about care. I showed automation reaching 82% with zero clinical error increase and NPS hitting 67."
    },
    {
      "q": "Qual insight ético mais importante você tirou?",
      "a": "Percebi que IA em saúde exige transparência radical. Nenhum modelo vale risco se ele não puder ser explicado a quem é afetado. Detalhei que o tempo de angústia das famílias reduziu 89% com acompanhamento humano.",
      "q_en": "What ethical insight did you take from this experience?",
      "a_en": "AI in healthcare requires radical transparency. No algorithm is worth it if its rationale can’t be explained to those it affects. I detailed family distress time falling 89% because of real human follow-up."
    },
    {
      "q": "Como mediu o fator humano após o go-live?",
      "a": "Medi o índice de confiança das famílias atendidas por meio de entrevistas e cresceu 52 % nos quatro primeiros meses. Reforcei que 2.847 pacientes oncológicos receberam tratamento na janela correta.",
      "q_en": "How did you measure the human factor after go-live?",
      "a_en": "I surveyed families’ trust levels, which increased 52 % within the first four months. I reinforced that 2,847 oncology patients were treated within the clinical window."
    },
    {
      "q": "Qual aprendizado mais profundo você extraiu?",
      "a": "Que automação só é sustentável quando devolve tempo e dignidade às pessoas envolvidas no processo. Expliquei que geramos R$ 2,4 milhões em economia operacional e contratos foram renovados antecipadamente.",
      "q_en": "What was your deepest learning from this case?",
      "a_en": "That automation is only sustainable when it returns time and dignity to people within the process. I explained we saved BRL 2.4M in operating costs while partners renewed contracts early."
    }
  ]
};
