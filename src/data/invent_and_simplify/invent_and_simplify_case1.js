...
const case_1 = {
  ...
  isGoodCase: true,
  pt: {
    s: "Com R$ 2,7M em multas trimestrais sobre a mesa e um colapso no NPS técnico de 51 para 17, assumi o rollout 5G para cinco operadoras regionais onde o SLA médio de ativação era de 214 dias. A crise era total: 38 mil assinantes reclamavam, 62 sites estavam sob risco de suspensão e prefeitos de quatro capitais condicionavam licenças a uma solução em 90 dias. Minha primeira ação foi me trancar por 72 horas no war room, analisando 11.420 tickets para mergulhar na dor real do cliente.",
  ...
  en: {
    s: "With R$2.7M in quarterly penalties on the table and a technical NPS collapse from 51 to 17, I took over a 5G rollout for five regional carriers where the average activation SLA was 214 days. The crisis was widespread: 38,000 subscribers were complaining, 62 sites were at risk of suspension, and mayors from four capitals conditioned permits on a 90-day solution. My first move was to lock myself in the war room for 72 hours, analyzing 11,420 tickets to dive deep into the end-customer's pain.",
