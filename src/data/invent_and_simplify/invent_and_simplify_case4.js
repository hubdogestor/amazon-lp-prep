...
const case_4 = {
  ...
  isGoodCase: true,
  pt: {
    s: `Eu encontrei o ecossistema de inovacao da Unimed travado por complexidade burocratica extrema: 47 projetos internos demoravam em media 21 meses para virar MVP, queimando R$ 2,1M cada um, e 63% eram cancelados sem tocar paciente algum. Doze startups parceiras tinham abandonado os pilotos porque levavam 140 dias para assinar NDA. Enquanto isso, 52 mil medicos cooperados reclamavam da burocracia e o NPS das solucoes digitais caiu de 55 para 28. Eu enxerguei que a dor nao era falta de ideias, mas excesso de camadas de aprovacao que matavam velocidade. Mantendo olhar externo, eu visitei oito cooperativas regionais em duas semanas e ouvi de gestores e pacientes que a dor real era a falta de solucoes simples para telemonitorar cronicos—e percebi que ninguem estava trazendo as praticas ageis do mercado fintech para dentro de casa.`,
    t: `Eu decidi ser owner de ponta a ponta e tracei a meta de inventar um hub aberto que gerasse MVP em seis meses, simplificando radicalmente o processo sem comprometer compliance ou qualidade clinica. Eu me comprometi a cortar o ciclo de aprovacao em 70%, entregar pelo menos tres solucoes com NPS acima de 60 ate o fim de 2023, e balancear inovacao com risco regulatorio atraves de mecanismos claros de governanca.`,
    a: `Primeiro, eu coletei dados de 1.260 horas de backlog e provei que 41% do tempo era gasto em comites desnecessarios. Eu decidi construir minha propria solucao—o "Fast-Track Klin"—em vez de contratar consultoria externa, porque precisava de algo customizado que acelerasse sem criar novos silos. Eu eliminei quatro camadas de aprovacao criando esse mecanismo onde eu, como sponsor, assinava contrato marco com startups em 10 dias e acionava um sandbox juridico. Segundo, eu mantive olhar externo constante: rodei 28 entrevistas com pacientes cronicos, analisei 180 mil mensagens da ouvidoria e priorizei solucoes de monitoramento remoto e adesao a terapias—trazendo essa escuta ativa de fora para dentro. Terceiro, eu enfrentei o trade-off classico entre inovacao e risco: o conselho financeiro temia exposure regulatorio, entao negociei um limite de R$ 15M com stop-loss por coorte e instalei OKRs vinculando retorno clinico e payback de 18 meses. Eu tambem organizei um "clinical demo day" onde cada startup apresentava resultados comigo e um medico patrocinador, convencendo lideres ceticos. Por fim, eu implementei a Plataforma de Inovacao aberta usando APIs FHIR e um repositório de dados que eu normalizei em quatro semanas, simplificando integracao de 140 dias para 10 dias.`,
    ...
    l: `Eu aprendi que simplicidade em inovacao corporativa so acontece quando alguem assume caneta unica para cortar burocracia, traz olhar externo constante (voz do cliente real) e balanceia risco com mecanismos claros. Construir solucao propria vs adaptar terceiros depende de quao especifico é o problema—no meu caso, a burocracia unica da Unimed exigia Fast-Track customizado. O mecanismo virou minha referencia para qualquer parceria fintech: contrato marco, voice of customer e sandbox legal que preserva velocidade sem comprometer compliance.`,
  },
  en: {
    s: `I found Unimed's innovation ecosystem paralyzed by extreme bureaucratic complexity: 47 internal projects took 21 months on average to reach MVP, burning R$ 2.1M each, and 63% were cancelled without touching any patient. Twelve partner startups had abandoned pilots because NDAs took 140 days to sign. Meanwhile 52 thousand cooperative physicians complained about bureaucracy and the digital solutions' NPS fell from 55 to 28. I saw the pain wasn't lack of ideas but excess approval layers killing speed. Keeping an external lens, I visited eight regional cooperatives in two weeks and heard from managers and patients that the true pain was the absence of simple tools to remotely monitor chronic conditions—and realized nobody was bringing agile fintech practices from outside in.`,
    t: `I chose to own end-to-end and set the goal to invent an open hub shipping MVPs in six months, radically simplifying the process without compromising compliance or clinical quality. I committed to shorten approval cycles by 70%, deliver at least three solutions with NPS above 60 by the end of 2023, and balance innovation with regulatory risk through clear governance mechanisms.`,
    a: `First, I collected data from 1,260 hours of backlog and proved 41% of time was wasted in unnecessary committees. I decided to build my own solution—the "Fast-Track Klin" mechanism—instead of hiring external consultancy, because I needed something custom that accelerated without creating new silos. I eliminated four approval layers by creating this mechanism where I, as sponsor, signed master agreements with startups in ten days and activated a legal sandbox. Second, I kept a constant external lens: I ran 28 interviews with chronic patients, analyzed 180 thousand ombudsman messages, and prioritized remote monitoring and therapy adherence solutions—bringing that active listening from outside in. Third, I faced the classic trade-off between innovation and risk: the finance board feared regulatory exposure, so I negotiated a R$ 15M cap with cohort stop-loss and installed OKRs linking clinical return and 18-month payback. I also organized a "clinical demo day" where each startup presented results alongside me and a physician sponsor, winning over skeptical leaders. Finally, I deployed the open innovation platform using FHIR APIs and a data repository I normalized within four weeks, simplifying integration from 140 days to 10 days.`,
    ...
    l: `I learned that simplicity in corporate innovation only happens when someone grabs a single pen to cut bureaucracy, brings constant external lens (real customer voice), and balances risk with clear mechanisms. Building your own solution vs adapting third-party depends on how specific the problem is—in my case, Unimed's unique bureaucracy required a custom Fast-Track. The mechanism became my blueprint for any fintech partnership: master agreement, customer voice, and a legal sandbox that preserves speed without compromising compliance.`,
  },
  fups: [
    {
