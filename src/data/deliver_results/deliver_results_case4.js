...
const case_4 = {
  ...
  isTopCase: false,
  pt: {
    s: `"Professor, cadê o dinheiro da merenda?" A frase de uma mãe em setembro de 2023 durante reunião de pais na Escola Estadual São José resumia o caos que descobri na CAGE: R$ 4,6M em repasses bloqueados por falta de rastreabilidade burocrática, afetando 47 mil alunos em 312 escolas. O problema era sistêmico e devastador: a Contadoria e Auditoria-Geral do Estado (CAGE) operava demandas via e-mail e planilha atendendo 8 secretarias estaduais críticas — Educação, Saúde, Segurança, Fazenda, Infraestrutura, Justiça, Planejamento e Obras — onde mais de 500 gestores submetiam 1.200 demandas mensais de repasse, prestação de contas e fiscalização. Stakes brutais: 34% dos pedidos estouravam o SLA regulatório de 15 dias, frustrando gestores que precisavam fechar orçamento e gerar transparência obrigatória ao cidadão via Lei de Acesso à Informação. NPS estimado das 8 secretarias despencara para 30, e eu documentei o caso mais emblemático do caos: a Secretaria de Educação reenviou a mesma solicitação de R$ 4,6M para merenda escolar para três analistas diferentes sem qualquer rastreabilidade, multiplicando trabalho desnecessário em 120 horas e atrasando repasse que alimentaria 47 mil crianças por 6 semanas. Diretores escolares ligavam diariamente cobrando respostas desesperadas, mas o analista da CAGE não conseguia localizar a demanda porque estava perdida no e-mail de outro colega sem backup. Resultado: crianças sem merenda, pais revoltados, gestores sob pressão do Tribunal de Contas e nenhum diretor querendo assumir ownership de uma solução que mexia com 8 feudos políticos simultâneos.`,
