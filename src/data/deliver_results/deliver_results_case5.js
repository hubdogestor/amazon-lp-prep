...
const case_5 = {
  ...
  isGoodCase: false,
  pt: {
    s: `Em marco de 2020 o Sicredi tinha prazo regulatorio do Banco Central para entregar o Pix em 16 de novembro. Eu era o Product Owner responsavel por coordenar 5 squads (payments, fraud, channels, core-banking, infra) e garantir a entrega no prazo. O Pix representava revolução na experiência de pagamento para 4.5 milhões de cooperados do Sicredi: transferências instantâneas 24/7 gratuitas vs. TED/DOC que custavam R$ 15-25 e levavam 24-48h. O escopo incluia 8 jornadas criticas (P2P, QR Code dinamico, Pix Saque, Pix Troco) com 23 dependencias tecnicas. Eu subestimei a complexidade das integrações do dict (diretorio de chaves) e confiei demais nas estimativas otimistas das squads. Em setembro ficou claro que nao entregariamos no prazo: testes de carga revelaram que o sistema suportava apenas 120 TPS contra os 450 TPS exigidos pelo BCB, e tinhamos 17 casos de borda de fraude sem tratamento. Perderiamos o deadline por 3 semanas, colocando a cooperativa em risco regulatorio e, pior ainda, deixando 4.5 milhões de cooperados sem acesso ao Pix enquanto concorrentes (Nubank, Inter, Banco do Brasil) já ofereciam o serviço.`,
    ...
    r: `Consegui entregar o Pix Core em 16 de novembro conforme novo acordo com BCB - 3 semanas depois do prazo original mas dentro do prazo renegociado. O sistema entrou em producao suportando 520 TPS (16% acima do minimo exigido), com 0 incidentes criticos nas primeiras 72 horas. Nos primeiros 30 dias processamos 2.8 milhoes de transacoes Pix com 99.2% de disponibilidade, entregando aos cooperados a experiência prometida: transferências instantâneas gratuitas 24/7. O feedback dos clientes foi imediato: NPS do Pix subiu de 45 (beta) para 68 (producao), com 87% dos cooperados reportando "experiência melhor que TED/DOC" e 92% preferindo Pix a métodos tradicionais. Economia média por cooperado: R$ 180/ano em tarifas de TED evitadas. A fase 2 (features avancadas) foi entregue em dezembro, 2 semanas antes do prazo, com 95% do valor do escopo original. Recuperei a confianca da lideranca: em janeiro fui promovido a Head of Payments e me pediram para aplicar os mesmos mecanismos de gestao em Open Banking. A matriz de dependencias e os gates de qualidade que criei viraram padrao para todos os projetos regulatorios do Sicredi acima de 50 pessoas.`,
  ...
  en: {
    ...
    r: `I delivered Pix Core on November 16 per new agreement with BCB - 3 weeks after original deadline but within renegotiated timeline. The system went live supporting 520 TPS (16% above required minimum), with 0 critical incidents in the first 72 hours. In the first 30 days we processed 2.8 million Pix transactions with 99.2% availability, delivering to members the promised experience: instant 24/7 free transfers. Customer feedback was immediate: Pix NPS rose from 45 (beta) to 68 (production), with 87% of members reporting "better experience than TED/DOC" and 92% preferring Pix to traditional methods. Average savings per member: R$ 180/year in avoided TED fees. Phase 2 (advanced features) was delivered in December, 2 weeks ahead of schedule, with 95% of original scope value. I recovered leadership's trust: in January I was promoted to Head of Payments and asked to apply the same management mechanisms to Open Banking. The dependency matrix and quality gates I created became standard for all Sicredi regulatory projects above 50 people.`,
