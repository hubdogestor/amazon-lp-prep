  ...
  cases: [
    {
      ...
      pt: {
        ...
        l: "Aprendi que métricas de alto nível são perigosas porque escondem a verdade. Um líder não pode operar à distância. Ele precisa ter a habilidade e a disposição de conectar-se aos dados brutos, auditar os detalhes e cruzar informações quantitativas e qualitativas para formar um diagnóstico preciso."
      },
      en: {
        ...
        a: "I didn't trust existing dashboards because they showed the 'what' (high churn), but not the 'where' or 'why.' I suspected that aggregated averages were masking the real problem. Therefore, I requested read access to our data warehouse and used Power BI and Firebase Analytics to conduct my own investigation, seeking truth in raw user event data. To find the 'when,' I used Power BI to build a cohort analysis that segmented users by signup week. This revealed a 'cliff': over 50% of churn occurred in the first 7 days. With this, I focused on the onboarding funnel in Firebase and identified the exact 'where': document upload, with a 40% abandonment rate. To ensure Firebase data was reliable, I cross-referenced three sources: Firebase event data (behavior), Data Warehouse transactional data (actual payment conversion), and Support tickets (qualitative voice). To understand the 'why,' I read over 500 support tickets and app store reviews. Qualitative analysis showed high frequency of complaints about 'invalid document' and 'registration error.' I compiled the quantitative and qualitative analysis into a business case and presented it to the product leadership committee. I showed that the ROI of fixing onboarding (increasing top-of-funnel conversion) was 3x greater than building a new feature.",
        ...
        l: "I learned that high-level metrics are dangerous because they hide the truth. A leader cannot operate at a distance. They need the ability and willingness to connect to raw data, audit details, and cross-reference quantitative and qualitative information to form a precise diagnosis."
      },
      fups: [
        {
    ...
    },
    {
      ...
      pt: {
        ...
        a: "Pedi à equipe de dados uma extração de todas as transações daquela rede nos últimos seis meses. Importei para o Power BI e comecei a investigar. Meu conhecimento em análise de dados me permitiu ir além dos filtros padrão. Comecei a usar visualizações para encontrar padrões escondidos. Ao plotar os IPs de submissão em um mapa, vi uma concentração geograficamente impossível. Ao criar um gráfico de dispersão de 'valor da transação' por 'hora do dia', notei um cluster massivo de transações de baixo valor entre 2 e 4 da manhã. O deep dive revelou o padrão: aproximadamente 50 pacientes diferentes recebiam reembolsos para o mesmo procedimento de baixo valor, de múltiplos médicos, submetidos de madrugada e do mesmo IP. Era um padrão de fraude 'low and slow', desenhado para passar sob o radar. Com a evidência, liderei um workshop com a equipe de ciência de dados. Eu não apenas relatei o problema; traduzi minhas descobertas em requisitos claros para novas 'features' do modelo (ex: 'criar uma variável para nº de pacientes por IP em 24h'). Priorizei esse trabalho no backlog e defini o KPI de sucesso: reduzir esse tipo de fraude em 90%.",
        r: "A investigação descobriu uma rede de fraude que era o maior esquema descoberto naquele ano, custando à empresa um valor estimado de R$ 2 milhões anuais. A atualização do modelo, baseada nos meus requisitos, foi implementada e reduziu as perdas por esse tipo de fraude em mais de 95% no trimestre seguinte. A analista que deu o alerta inicial foi publicamente reconhecida, criando uma cultura onde os insights humanos são valorizados.",
