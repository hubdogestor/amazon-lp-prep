const case_5 = {
  ...
  fups: [
    ...
    },
    {
      ...
      a: "Identifiquei que 42% dos atrasos vinham de janelas descasadas; calculei impacto de 0,4 p.p. no custo de capital por dia de atraso.",
      q_en: "What data did you use and what was your calculation rationale?",
      a_en: "Identified 42% of delays from mismatched windows; calculated 0.4 p.p. capital cost impact per delay day."
    },
    {
      q: "Como você usou o aprendizado deste caso em outros contextos?",
      a: "Replicamos 'Check 7h' em cinco áreas do Bradesco; auditoria interna citou como referência de governança operacional.",
      q_en: "How did you apply this learning elsewhere?",
      a_en: "Replicated 'Check 7h' across five Bradesco areas; internal audit cited it as operational governance reference."
    },
    {
    ...
    },
    {
      ...
      a: "Realizei análise de causa-raiz cruzando logs de tesouraria com timestamps de conciliação em janelas de 10 minutos.",
      q_en: "How did you identify that 42% of delays came from cut-off and credit window mismatch?",
      a_en: "Ran root-cause analysis crossing treasury logs with reconciliation timestamps in 10-minute windows."
    },
    {
      q: "Qual foi o momento específico que transformou o diretor de receptor de más notícias em participante ativo?",
      a: "Quando assumi publicamente erros de outras áreas no 'Check 7h' e ele viu que transparência gerava controle, não exposição.",
      q_en: "Which specific moment turned the director from news recipient into active participant?",
      a_en: "When I publicly owned errors from other areas in 'Check 7h' and he saw transparency created control, not exposure."
    },
    {
      q: "Como você convenceu tecnologia a aprovar janela exclusiva 2h-4h sem custo adicional?",
      a: "Mostrei que atrasos custavam 0,4 p.p. em capital diário e que janela noturna tinha capacidade ociosa de 78%.",
      q_en: "How did you convince tech to approve exclusive 2-4 a.m. window without extra cost?",
      a_en: "Showed delays cost 0.4 p.p. daily capital and that night window had 78% idle capacity."
    },
    {
      q: "Como você superou resistência do coordenador que temia exposição diária?",
      a: "Levei dados de perda de contratos, estabeleci regra de não citar nomes (só tempos) e equipe passou a antecipar relatórios.",
      q_en: "How did you overcome coordinator resistance who feared daily exposure?",
      a_en: "Presented contract-loss data, set rule to discuss times not names, and team began anticipating reports."
    },
    {
      q: "Quais métricas específicas do 'Check 7h' tiveram maior impacto na recuperação da confiança?",
      a: "Taxa fora do D+1 caiu de 7,1% para 0,12%, conciliação automática subiu para 94% e tempo de correção caiu para 2h50.",
      q_en: "Which specific 'Check 7h' metrics had greatest impact on trust recovery?",
      a_en: "Late rate fell from 7.1% to 0.12%, auto-reconciliation rose to 94%, and fix time dropped to 2h50."
    },
    {
      q: "Como o piloto com os dois maiores clientes gerou momentum para institucionalização?",
      a: "Atrasos caíram 73% em uma semana; compartilhei resultados em tempo real e diretor pediu escala imediata.",
      q_en: "How did the pilot with two top clients create momentum for institutionalization?",
      a_en: "Delays fell 73% in one week; shared results live and director requested immediate scale."
    },
    {
      q: "Qual foi o impacto financeiro direto da iniciativa em termos de economia e retenção?",
      a: "Economizamos R$ 2,3 milhões em custo de capital e retivemos quatro contratos estratégicos sem desconto de margem.",
      q_en: "What was the direct financial impact of the initiative in savings and retention?",
      a_en: "Saved BRL 2.3M in capital cost and retained four strategic contracts at full margin."
    },
    {
      q: "Como você garantiu que equipe mantivesse ritmo após primeiros 45 dias de sucesso?",
      a: "Mantive 'Check 7h' diário, celebrei micro-vitórias e liguei métricas ao bônus trimestral da área.",
      q_en: "How did you ensure team maintained pace after first 45 days of success?",
      a_en: "Kept daily 'Check 7h', celebrated micro-wins, and linked metrics to quarterly team bonus."
    },
    {
      q: "Quais sinais indicaram que a confiança do diretor estava sendo restaurada?",
      a: "Passou de ameaçar transferir operação para me defender em reuniões de board e pedir expansão do modelo.",
      q_en: "Which signals showed the director's trust was being restored?",
      a_en: "Shifted from threatening operation transfer to defending me in board meetings and requesting model expansion."
    }
  ]
};
