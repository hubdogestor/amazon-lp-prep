  ...
  "fups": [
    {
      ...
      "a": "Demorei dois dias para me posicionar publicamente; aprendi que silêncio prolongado aumenta a percepção de descontrole. Detalhei que em 9 dias zeramos o backlog de R$ 420 milhões e restabelecemos o SLA D+1 com variação de saldo em 0,08%.",
      "q_en": "What was your biggest mistake or failure in this case?",
      "a_en": "I waited two days to speak publicly; silence amplified the sense of chaos. I detailed clearing the BRL 420M backlog in nine days, restoring D+1 SLA with balance variance at 0.08%."
    },
    {
      "q": "O que você faria diferente hoje?",
      "a": "Criaria protocolo preventivo de comunicação com parceiros e relatórios diários de liquidez antes do corte D+1. Mostrei que o churn de sellers caiu 3,9 pontos e o NPS do parceiro subiu de 18 para 63 em seis semanas.",
      "q_en": "What would you do differently today?",
      "a_en": "I would set preventive partner communication and daily liquidity reports before the D+1 cutoff. I showed seller churn dropping 3.9 points and partner NPS jumping from 18 to 63 within six weeks."
    },
    {
      "q": "Qual foi o obstáculo mais difícil de superar?",
      "a": "Convencer o CFO e operações ao mesmo tempo: um resistia por custo, o outro por exposição. Resolvi com simulações financeiras e limites claros de compliance. Reforcei que o contrato foi renovado por dois anos com revisões trimestrais coassinadas.",
      "q_en": "What was the hardest obstacle to overcome?",
      "a_en": "Convincing both CFO and operations--one worried about cost, the other about exposure. I solved it with financial simulations and clear compliance boundaries. I reinforced the partner renewed for two years with quarterly co-signed reviews."
    },
    {
      "q": "Quais foram os principais riscos e como você os mitigou?",
      "a": "Perder o contrato definitivamente e sofrer dano reputacional. Mitiguei com transparência diária, auditoria externa e garantia financeira dedicada. Expliquei que o Saldo Garantido agora cobre R$ 1,2 bilhão em TPV e reduziu escaladas em 46%.",
      "q_en": "What were the main risks and how did you mitigate them?",
      "a_en": "Permanent contract loss and reputational damage. Mitigated with daily transparency, external audit, and a dedicated liquidity guarantee. I explained the Guaranteed Balance model now shields BRL 1.2B TPV and cut escalations by 46%."
    },
    {
      "q": "Que dados você usou e qual foi a racional de cálculo?",
      "a": "Analisei fluxo de recompra vs crédito, calculei buffer de R$ 80 mi e modelei perda de R$ 52 mi/ano caso perdêssemos o parceiro. Citei que o caso virou workshop interno de governança e transformou transparência em vantagem competitiva.",
      "q_en": "What data did you use and what was your calculation rationale?",
      "a_en": "Analyzed buyback vs credit flow, calculated BRL 80M buffer, and modeled BRL 52M/year loss if we lost the partner. I cited how the case became our trust governance workshop and turned transparency into a competitive edge."
    },
    {
      "q": "Como você usou o aprendizado deste caso em outros contextos?",
      "a": "Replicamos 'Saldo Garantido' em quatro marketplaces, cobrindo R$ 1,2 bi em TPV e reduzindo chamados em 46%. Detalhei que em 9 dias zeramos o backlog de R$ 420 milhões e restabelecemos o SLA D+1 com variação de saldo em 0,08%.",
      "q_en": "How did you apply this learning elsewhere?",
      "a_en": "Replicated 'Guaranteed Balance' across four marketplaces, covering BRL 1.2B TPV and cutting tickets by 46%. I detailed clearing the BRL 420M backlog in nine days, restoring D+1 SLA with balance variance at 0.08%."
    },
    {
      "q": "Como o parceiro reagiu às medidas de transparência?",
      "a": "Relatou sentir-se \"dentro da sala de controle\" e passou a cocriar indicadores conosco, sinal de confiança restabelecida. Mostrei que o churn de sellers caiu 3,9 pontos e o NPS do parceiro subiu de 18 para 63 em seis semanas.",
      "q_en": "How did the partner react to the transparency measures?",
      "a_en": "They said they felt \"inside the control room\" and began co-creating indicators--evidence trust was rebuilt. I showed seller churn dropping 3.9 points and partner NPS jumping from 18 to 63 within six weeks."
    },
    {
      "q": "Como o caso foi reaplicado em outros clientes?",
      "a": "O modelo 'Saldo Garantido' foi expandido para quatro marketplaces adicionais e reduziu chamados de liquidação em 46%. Reforcei que o contrato foi renovado por dois anos com revisões trimestrais coassinadas.",
      "q_en": "How was the case replicated elsewhere?",
      "a_en": "The 'Guaranteed Balance' model scaled to four more marketplaces and cut settlement tickets by 46%. I reinforced the partner renewed for two years with quarterly co-signed reviews."
    },
    {
      "q": "Como você convenceu o CFO a aprovar o buffer de R$ 80 milhões em ambiente de juros altos?",
      "a": "Mostrei que perder o parceiro custaria R$ 52 mi/ano e cortei 18% do meu budget de marketing para compensar imobilização. Expliquei que o Saldo Garantido agora cobre R$ 1,2 bilhão em TPV e reduziu escaladas em 46%.",
      "q_en": "How did you convince the CFO to approve BRL 80M buffer in high-interest environment?",
      "a_en": "Showed losing partner would cost BRL 52M/year and cut 18% of my marketing budget to offset immobilization. I explained the Guaranteed Balance model now shields BRL 1.2B TPV and cut escalations by 46%."
    },
    {
      "q": "Qual foi o impacto do 'Monitor de Confiança' com 12 métricas nos stand-ups diários?",
      "a": "Transformou relacionamento de reativo para proativo; parceiro passou a antecipar ajustes antes de problemas escalarem. Citei que o caso virou workshop interno de governança e transformou transparência em vantagem competitiva.",
      "q_en": "What was the impact of the 'Trust Monitor' with 12 metrics in daily stand-ups?",
      "a_en": "Shifted relationship from reactive to proactive; partner began anticipating adjustments before issues escalated. I cited how the case became our trust governance workshop and turned transparency into a competitive edge."
    },
    {
      "q": "Como você garantiu que operações aderisse ao modelo de transparência apesar do medo de exposição?",
      "a": "Defini limites claros de compliance, mostrei que opacidade havia custado 18% de market share e equipe passou a sugerir métricas. Detalhei que em 9 dias zeramos o backlog de R$ 420 milhões e restabelecemos o SLA D+1 com variação de saldo em 0,08%.",
      "q_en": "How did you ensure operations adopted transparency despite fear of exposure?",
      "a_en": "Set clear compliance boundaries, showed opacity cost 18% market share, and team started suggesting metrics. I detailed clearing the BRL 420M backlog in nine days, restoring D+1 SLA with balance variance at 0.08%."
    },
    {
      "q": "Quais sinais indicaram que a confiança estava sendo restaurada durante o processo?",
      "a": "NPS do parceiro subiu de 18 para 63, churn de sellers caiu 3,9 p.p. e parceiro aceitou renovação bianual. Mostrei que o churn de sellers caiu 3,9 pontos e o NPS do parceiro subiu de 18 para 63 em seis semanas.",
      "q_en": "Which signals showed trust was being restored during the process?",
      "a_en": "Partner NPS rose from 18 to 63, seller churn fell 3.9 p.p., and partner accepted two-year renewal. I showed seller churn dropping 3.9 points and partner NPS jumping from 18 to 63 within six weeks."
    },
    {
      "q": "Como o workshop de governança de confiança impactou outras áreas do Bradesco?",
      "a": "Três áreas adotaram rituais similares de transparência diária, reduzindo tempo médio de resolução de conflitos em 52%. Reforcei que o contrato foi renovado por dois anos com revisões trimestrais coassinadas.",
      "q_en": "How did the trust governance workshop impact other Bradesco areas?",
      "a_en": "Three areas adopted similar daily transparency rituals, cutting average conflict resolution time by 52%. I reinforced the partner renewed for two years with quarterly co-signed reviews."
    },
    {
      "q": "Qual foi a reação dos 8.700 sellers após a normalização do backlog?",
      "a": "Protestos públicos cessaram, taxa de abandono caiu e três sellers tornaram-se promotores ativos da plataforma. Expliquei que o Saldo Garantido agora cobre R$ 1,2 bilhão em TPV e reduziu escaladas em 46%.",
      "q_en": "How did 8,700 sellers react after backlog normalization?",
      "a_en": "Public protests stopped, abandonment rate dropped, and three sellers became active platform promoters. I explained the Guaranteed Balance model now shields BRL 1.2B TPV and cut escalations by 46%."
    },
    {
      "q": "Como você mediu o ROI da iniciativa 'Saldo Garantido'?",
      "a": "Economizamos R$ 52 mi/ano em receita retida, reduzimos 46% de chamados e expandimos para R$ 1,2 bi em TPV adicional. Citei que o caso virou workshop interno de governança e transformou transparência em vantagem competitiva.",
      "q_en": "How did you measure ROI of 'Guaranteed Balance' initiative?",
      "a_en": "Saved BRL 52M/year in retained revenue, cut 46% tickets, and expanded to BRL 1.2B additional TPV. I cited how the case became our trust governance workshop and turned transparency into a competitive edge."
    }
  ]
};
