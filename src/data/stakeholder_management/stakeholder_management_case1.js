...
const case_1 = {
  ...
  "keywords": "#stakeholders | #governança | #criar-mecanismos | #escalabilidade | #programa-complexo",
  "isTopCase": false,
  "isGoodCase": false,
  "pt": {
  ...
  "fups": [
    {
      ...
      "a": "Meu maior erro foi subestimar a resistência política inicial dos diretores locais, que estavam confortáveis com metas incrementais. Perdi 6 semanas tentando convencê-los, quando deveria ter envolvido o VP Global desde o início para criar pressão top-down. Isso atrasou o piloto e quase comprometeu o business case. Detalhei que o lead time caiu de 382 para 62 dias, liberando 1.136 sites e antecipando R$ 1,1 bilhão em receita.",
      "q_en": "What was your biggest mistake or failure in this case?",
      "a_en": "My biggest mistake was underestimating the initial political resistance from local directors comfortable with incremental goals. I lost 6 weeks convincing them when I should have involved the Global VP early to create top-down pressure. This delayed the pilot and nearly compromised the business case. I detailed cutting lead time from 382 to 62 days, unlocking 1,136 sites and BRL 1.1B in accelerated revenue."
    },
    {
      "q": "O que você faria diferente hoje?",
      "a": "Hoje, eu construiria uma coalizão executiva global desde o dia 1, não após o piloto. Envolveria o CFO, o VP Global e líderes de 3 regiões-chave no workshop inicial de design, criando ownership compartilhado e acelerando a aprovação de CAPEX em pelo menos 2 meses. Mostrei que o modelo escalou para 54 operações globais após o summit de 2017.",
      "q_en": "What would you do differently today?",
      "a_en": "Would build global executive coalition from day 1, not after pilot. Would involve CFO, Global VP and leads from 3 key regions in initial design workshop, creating shared ownership and accelerating CAPEX approval by at least 2 months. I showed the model scaling to 54 global operations after the 2017 summit."
    },
    {
      ...
      "a_en": "Convincing Asia CFO to freeze US$6M for replication when he prioritized 5G. Had to present sensitivity analysis showing US$18M/month revenue loss from 4G delays and bring LatAm CEO testimony on market share loss. Took 3 weeks of intense negotiation. I reinforced the global average holding at 58 days with US$120M cumulative savings."
    },
    {
      "q": "Quais foram os principais riscos e como você os mitigou?",
      "a": "Os principais riscos eram: 1) Congelamento de 48 projetos críticos, que mitiguei com buffers contratuais; 2) Sobrecarga de CAPEX, resolvida com um modelo de co-investimento 40/60 com as regiões; 3) Resistência dos fornecedores, superada com o Vendor Performance Index; 4) Risco de compliance, gerenciado com uma matriz de 86 requisitos regulatórios e auditoria digital. Expliquei que US$ 80 milhões vieram de receita antecipada, US$ 25 milhões de renegociação e US$ 15 milhões de retrabalho evitado.",
      "q_en": "What were the main risks and how did you mitigate them?",
      "a_en": "1) Freezing 48 critical projects: created contractual buffers with carriers; 2) CAPEX overload: structured 40/60 co-investment with regions; 3) Vendor pushback: launched Vendor Performance Index with economic incentive (+30% volume for top); 4) Compliance loss: 86-requirement regulatory matrix with digital audit trail. I explained US$80M came from accelerated revenue, US$25M from renegotiation, and US$15M from avoided rework."
    },
    {
      "q": "Que dados você usou e qual foi a racional de cálculo?",
      "a": "Mapeei 127 gargalos no piloto de São Paulo e priorizei 19 alavancas que somavam 220 dias de desperdício. Comparei 12 indicadores antes e depois (lead time, aprovação na 1ª inspeção, custo/torre, etc.). Calculei um NPV de R$480M para o rollout global vs. local, com payback de 11 meses. O ROI final acumulado foi de US$120M. Citei que o NPS interno subiu de 41 para 68 e o SLA crítico <72h saltou de 42% para 91%.",
      "q_en": "What data did you use and what was your calculation rationale?",
      "a_en": "Mapped 127 bottlenecks in São Paulo pilot and prioritized 19 levers worth 220 wasted days. Compared 12 before/after indicators (lead time, first-pass approval, cost/tower, license backlog, carrier NPS). Calculated BRL 480M NPV for global vs local rollout, 11-month payback. Final ROI: US$120M cumulative (2014-2023). I cited internal NPS rising 41→68 and the <72h critical SLA jumping from 42% to 91%."
    },
    {
      "q": "Como você usou o aprendizado desse caso em outras frentes / trabalhos?",
      "a": "O Rollout Excellence Playbook virou padrão em 54 operações Huawei globalmente. Repliquei a lógica de co-investimento regional em 3 programas de transformação digital (pagamentos, CRM, supply chain), sempre ancorando sustentabilidade em auditorias semestrais + comunidade de práticas. Redução média de cycle time de 40% nesses programas. Detalhei que o lead time caiu de 382 para 62 dias, liberando 1.136 sites e antecipando R$ 1,1 bilhão em receita.",
      "q_en": "How did you use the learning from this case in other fronts / works?",
      "a_en": "Rollout Excellence Playbook became standard across 54 Huawei operations globally. Replicated regional co-investment logic in 3 digital transformation programs (payments, CRM, supply chain), always anchoring sustainability in semiannual audits + community of practice. Average 40% cycle time reduction in those programs. I detailed cutting lead time from 382 to 62 days, unlocking 1,136 sites and BRL 1.1B in accelerated revenue."
    },
    {
      "q": "Como você enfrentou o argumento do VP LatAm para manter o escopo apenas no Brasil?",
      "a": "Eu mostrei o custo de oportunidade: projetei cenário em que o Brasil evoluiria sozinho e contrastei com rollout coordenado. O case evidenciou BRL 480M em valor adicional e reduziu o payback global para 11 meses, desmontando a tese de foco local. Mostrei que o modelo escalou para 54 operações globais após o summit de 2017.",
      "q_en": "How did you challenge the LatAm VP's request to stay local?",
      "a_en": "I exposed the opportunity cost: modeled Brazil evolving alone versus coordinated rollout. The case showed BRL 480M additional value and cut global payback to 11 months, dismantling the “stay local” argument. I showed the model scaling to 54 global operations after the 2017 summit."
    },
    {
      "q": "Quais métricas você usou para provar que o piloto paulista era exportável?",
      "a": "Eu comparei 12 indicadores base antes/depois: lead time diário, % de sites aprovados na primeira inspeção, custo por torre, backlog de licenças municipais e satisfação da operadora. Exportabilidade veio quando 10 desses 12 itens ficaram acima dos benchmarks globais. Reforcei que a média global estabilizou em 58 dias com savings acumulados de US$ 120 milhões.",
      "q_en": "Which metrics did you use to prove the São Paulo pilot was exportable?",
      "a_en": "I compared 12 before/after indicators: daily lead time, first-pass approval rate, cost per tower, municipal license backlog, and carrier satisfaction. Once 10 of those 12 beat global benchmarks, I documented it as export-ready. I reinforced the global average holding at 58 days with US$120M cumulative savings."
    },
    {
      "q": "Como o Vendor Performance Index mudou o comportamento dos fornecedores?",
      "a": "Eu publiquei rankings semanais e atrelei 30% do volume às notas. Fornecedores que saltaram de 82% para >95% ganharam contratos extras de R$18M e quem ficou abaixo de 90% perdeu prioridade. O incentivo econômico transformou a relação em parceria estratégica. Expliquei que US$ 80 milhões vieram de receita antecipada, US$ 25 milhões de renegociação e US$ 15 milhões de retrabalho evitado.",
      "q_en": "How did the Vendor Performance Index shift supplier behavior?",
      "a_en": "I published weekly rankings and tied 30% of volume to the scores. Vendors jumping from 82% to >95% received R$18M extra in contracts, while those under 90% lost priority. The economic signal reframed the relationship into a strategic partnership. I explained US$80M came from accelerated revenue, US$25M from renegotiation, and US$15M from avoided rework."
    },
    {
      "q": "Que mecanismos garantiram sustentabilidade do playbook após 2023?",
      "a": "Eu ancorei o playbook em auditorias semestrais conduzidas pela controladoria e numa comunidade global de práticas com OKRs próprios. Em 2023, 87% das filiais mantiveram score >4,5/5 nessas auditorias, comprovando aderência contínua. Citei que o NPS interno subiu de 41 para 68 e o SLA crítico <72h saltou de 42% para 91%.",
      "q_en": "Which mechanisms kept the playbook alive after 2023?",
      "a_en": "I tied the playbook to semiannual audits led by controllership and a global community of practice with dedicated OKRs. In 2023, 87% of subsidiaries stayed above 4.5/5, proving sustained adoption. I cited internal NPS rising 41→68 and the <72h critical SLA jumping from 42% to 91%."
    },
    {
      "q": "Como você protegeu a iniciativa diante do risco de sobrecarga de CAPEX?",
      "a": "Eu criei um modelo de co-investimento: regiões aportavam 40% do CAPEX e a matriz financiava 60% condicionado a metas de adoção. Esse mecanismo liberou US$6M sem estourar orçamento local e garantiu comprometimento das filiais. Detalhei que o lead time caiu de 382 para 62 dias, liberando 1.136 sites e antecipando R$ 1,1 bilhão em receita.",
      "q_en": "How did you shield the initiative from CAPEX overload risk?",
      "a_en": "I structured co-investment: regions funded 40% of CAPEX and HQ matched 60% contingent on adoption targets. It released US$6M without breaking local budgets and locked in subsidiary commitment. I detailed cutting lead time from 382 to 62 days, unlocking 1,136 sites and BRL 1.1B in accelerated revenue."
    },
    {
      "q": "Como você garantiu compliance simultâneo em 14 países diferentes?",
      "a": "Eu criei uma matriz de 86 requisitos regulatórios por região, contratei escritórios locais por sprint crítica e estabeleci trilha de auditoria digital assinada pelo jurídico. Resultado: zero não conformidades nas inspeções de 2014-2023. Mostrei que o modelo escalou para 54 operações globais após o summit de 2017.",
      "q_en": "How did you ensure compliance across 14 different countries?",
      "a_en": "I built a grid with 86 regulatory requirements per region, hired local firms for each critical sprint, and enforced a digital audit trail signed by legal. Result: zero non-compliances in the 2014-2023 inspections. I showed the model scaling to 54 global operations after the 2017 summit."
    },
    {
      "q": "De que forma você mensurou o impacto para as operadoras cliente?",
      "a": "Eu coletei NPS trimestral com cinco operadoras âncoras e medi três métricas: tempo até ativação comercial, incidência de retrabalho e disponibilidade média no primeiro mês. As melhorias (NPS +27, retrabalho -61%, disponibilidade +9pp) entraram no dashboard executivo. Reforcei que a média global estabilizou em 58 dias com savings acumulados de US$ 120 milhões.",
      "q_en": "How did you measure impact for carrier customers?",
      "a_en": "I ran quarterly NPS with five anchor carriers and tracked time-to-commercial activation, rework incidents, and first-month availability. Improvements (NPS +27, rework -61%, availability +9pp) fed the executive dashboard. I reinforced the global average holding at 58 days with US$120M cumulative savings."
    },
    {
      "q": "Como você preparou a sucessão para que o modelo continuasse sem você?",
      "a": "Eu formei quatro líderes regionais, cada um com OKR de replicar o playbook em dois novos países por semestre. Também criei academy virtual com 12 módulos microlearning. Mesmo após minha saída em 2018, a cadência de rollout seguiu dentro do target de 60 dias. Expliquei que US$ 80 milhões vieram de receita antecipada, US$ 25 milhões de renegociação e US$ 15 milhões de retrabalho evitado.",
      "q_en": "How did you prepare succession so the model kept running without you?",
      "a_en": "I trained four regional leads, each with an OKR to replicate the playbook in two new countries per semester. I also launched a 12-module microlearning academy. After I left in 2018, rollout cadence stayed within the 60-day target. I explained US$80M came from accelerated revenue, US$25M from renegotiation, and US$15M from avoided rework."
    }
  ]
};
